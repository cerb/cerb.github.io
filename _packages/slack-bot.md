...
If you haven't already, follow [these instructions](/guides/integrations/slack/configure-plugin/) to install and configure the Slack plugin, and add your first connected account.
