...
If you haven't already, follow [these instructions](/guides/integrations/salesforce/configure-plugin/) to install and configure the Salesforce plugin, and add your first connected account.
