...
excerpt: A read-only control-flow graph of an automation, available as a card, profile, or workspace widget.
...
permalink: /docs/dashboards/widgets/automation-graph/
toc:
...
<img src="/assets/images/docs/dashboards/widgets/automation-graph.png" class="screenshot">
</div>
