...
excerpt: An interactive metric chart builder for record cards, with live editing and export.
...
permalink: /docs/dashboards/widgets/metrics-explorer/
toc:
  title: Chart Metrics Explorer
  expand: Reference
jumbotron:
  title: Chart Metrics Explorer
  tagline: ~
...
<img src="/assets/images/docs/dashboards/widgets/metrics-explorer.png" class="screenshot">
</div>
