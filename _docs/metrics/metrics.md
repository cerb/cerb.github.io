...
| Metric | Description
|-|-
|[cerb.agent.model.tokens.cache_read](/docs/metrics/cerb.agent.model.tokens.cache_read/)| Prompt tokens served from a provider's cache per [agent](/docs/agents/) turn. Dimensions: `model_id`, `agent_id`, and `worker_id`.
|[cerb.agent.model.tokens.cache_write](/docs/metrics/cerb.agent.model.tokens.cache_write/)| Prompt tokens written to a provider's cache per [agent](/docs/agents/) turn. Dimensions: `model_id`, `agent_id`, and `worker_id`.
