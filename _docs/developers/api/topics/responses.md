...
A dictionary is an array of **keys** and their associated **values**.  You may recognize some of the keys in the example above, because these dictionaries are also used by features like [bots](/docs/bots/), snippets, [dashboard widgets](/docs/dashboards/), and [worklist](/docs/worklists/) exports.
