...
<div class="cerb-box note">
	<p>If <b>Cerb</b> is already installed and you want to learn how to use it, you can <a href="/docs/records">skip ahead</a>.  If you're using <b>Cerb Cloud</b> you can <a href="/docs/quick-start">skip ahead to Quick Start</a>. We've already handled the installation for you.</p>
</div>
