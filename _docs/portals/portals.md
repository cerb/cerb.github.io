---
title: Portals
excerpt: Portals provide a way to publicly and securely share Cerb data with your
  customers and partners.
summary: This page provides information about Cerb's Portals, which are standalone
  websites that allow for the secure and public sharing of data with customers and
  partners. It highlights the modern portal types available, such as Website Interactions
  for public interactions on any website and Webhook for responding to HTTP requests
  with automations. Additionally, it mentions the ability to create and install new
  community portal types through plugins. The page also notes the retirement of legacy
  portal types like Chat Bot and Support Center, with guidance on migrating to newer
  solutions. A resource guide for hosting community portals using Nginx is also referenced.
