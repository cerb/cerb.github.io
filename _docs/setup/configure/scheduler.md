---
title: Scheduler
excerpt: The scheduler runs Cerb's background jobs -- mailbox checking, search
  indexing, nightly maintenance, the parallel queue, and more.
summary: This page documents Cerb's scheduler -- the system that runs background
  jobs like mailbox checking, search indexing, nightly maintenance, the parallel
