---
title: Icon Builder
excerpt: This page shows how to access and use the Icon Builder in the developer menu.
...
permalink: /docs/setup/developers/icon-builder/
toc:
  expand: Admin Guide
jumbotron:
  title: Icon Builder
...
<img src="/assets/images/docs/setup/icon-builder.png" class="screenshot">
</div>
...
Click **Setup &raquo; Configure &raquo; Developers &raquo; Icon Builder**. This tool is limited to administrators.
...
That wrapper is why every Cerb icon looks like it belongs to one set: a 24&times;24 canvas, no fill, and a rounded 2-unit stroke. The canvas is fixed -- everything you draw is placed on those 24 units.
...
<div class="cerb-box note">
	<p>
		<b>Copying out is the only way the work survives.</b> The current geometry is kept for the
		browser session, so a reload or a click away won't lose it, but nothing is stored on the server.
		Close the tab without copying both lines into the two source files and the icon is gone.
	</p>
</div>
