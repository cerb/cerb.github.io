---
title: llm.tool
excerpt: This page provides an overview of the **llm.tool** feature in Cerb, which allows 
  for the creation of reusable shared functions that can be triggered by AI agents using 
  large language models.
summary: This page provides an overview of the **llm.tool** feature in Cerb, which allows 
  for the creation of reusable shared functions that can be triggered by AI agents using 
  large language models. It details the structure of inputs and outputs for these functions, 
  explaining that the automation dictionary begins with custom input values from the caller. 
  The page also describes how the function returns key/value pairs to the caller, with the 
  possibility of nesting keys to return dictionaries.
permalink: /docs/automations/triggers/llm.tool/
toc:
  title: llm.tool
  expand: Automations
jumbotron:
...
{% tabs llm-tool-example-cerb-docs %}

{% tab llm-tool-example-cerb-docs automation %}
{% highlight cerb %}
{% raw %}
inputs:
  text/query:
...
{% tab llm-tool-example-cerb-docs policy %}
{% highlight cerb %}
{% raw %}
commands:
  http.request:
...
{% tab llm-tool-example-cerb-docs inputs %}
{% highlight cerb %}
{% raw %}
inputs:
  query: What is Cerb?
...
{% tab llm-tool-example-cerb-docs output %}
{% highlight cerb %}
{% raw %}
__exit: return
__return:
