...
| [**interaction.worker.agent**](/docs/plugins/extensions/cerb.trigger.interaction.worker.agent/) | `cerb.trigger.interaction.worker.agent`
| **interaction.worker.explore** | `cerb.trigger.interaction.worker.explore`
| **llm.tool** | `cerb.trigger.llm.tool`
...
| **mail.moved** | `cerb.trigger.mail.moved`
...
| **queue.consumer** | `cerb.trigger.queue.consumer`
...
| **record.merged** | `cerb.trigger.record.merged`
| **record.viewed** | `cerb.trigger.record.viewed`
