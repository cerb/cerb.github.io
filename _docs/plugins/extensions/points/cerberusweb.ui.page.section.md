...
| Automation Event Listener Section | `cerb.page.profiles.automation_event_listener`
| Automation Event Section | `cerb.page.profiles.automation_event`
| Automation Events Section | `core.page.setup.developers.automation_events`
| Automation Logs | `core.page.setup.developers.automation_logs`
| Automation Scripting Tester | `core.page.setup.developers.bot_scripting_tester`
| Automation Section | `cerb.page.profiles.automation`
...
| Database Schema | `core.page.setup.developers.database_schema`
...
| Icon Builder | `core.page.setup.developers.icon_builder`
...
| LLM Agent Transcripts | `core.page.setup.developers.llm_agent_transcripts`
| License Section | `core.page.setup.license`
| Localization Section | `core.page.setup.localization`
| Mail Delivery Log Section | `cerb.page.profiles.mail_delivery_log`
| Mail Inbound Log Section | `cerb.page.profiles.mail_inbound_log`
| Mail Routing Rule Section | `cerb.page.profiles.mail_routing_rule`
...
| Metric Section | `cerb.page.profiles.metric`
...
| Platform | `core.page.setup.developers.platform`
...
| Resource Section | `core.page.profiles.resource`
...
| Search Index Section | `cerb.page.profiles.search_index`
| Security Section | `core.page.setup.security`
| Server Page Section | `cerberusweb.profiles.server`
| Service Token Section | `cerb.page.profiles.service_token`
| Service Tokens Section | `core.page.setup.service_tokens`
| Sessions Section | `core.page.setup.sessions`
| Setup Page Translations Section | `translators.setup.section.translations`
| Sheet Builder | `core.page.setup.developers.sheet_builder`
...
| Toolbar Section | `core.page.profiles.toolbar`
| Toolbar Section Section | `cerb.page.profiles.toolbar_section`
| Toolbars Section | `core.page.setup.developers.toolbars`
| UI Reference | `core.page.setup.developers.ui.reference`
...
| Workflow Builder | `core.page.setup.developers.workflow_builder`
| Workflow Section | `cerb.page.profiles.workflow`
