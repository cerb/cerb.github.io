---
title: Tickets
permalink: /docsRefer to the [/records](/docs/api/endpoints/records/) API endpoint.tickets/
jumbotron:
  title: Tickets
  tagline: ""
  breadcrumbs:
...
| Field | Type | 
|-|-|-
| `bucket_id` | id | [bucket](/docs/api/endpoints/groups/)
| `group_id` | id | [group](/docs/api/endpoints/groups/)
| `org_id` | id | [organization](/docs/api/endpoints/organizations/)
| `owner_id` | id | [worker](/docs/api/endpoints/workers/)
| `status_id` | integer | 0=open, 1=waiting, 2=closed, 3=deleted
| `subject` | string
