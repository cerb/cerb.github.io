...
summary: This page provides detailed information about Queue Records in Cerb, including
  ...
  the Records API, such as creation and update timestamps, links, the queue name, and
  the retry and claim window settings that govern how failed and stalled messages are
  handled.
