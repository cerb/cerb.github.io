...
excerpt: This page provides detailed information about Queue Job records in Cerb,
  including their structure and usage within the system.
summary: Queue jobs group together related queue messages so workers can monitor
  long-running background work -- bulk updates, file imports/exports, search re-indexing,
