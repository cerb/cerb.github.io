...
permalink: /docs/bots/events/event.interaction.chat.portal/
toc:
  title: "Handle chat interaction with portal visitor"
  expand: Bots
jumbotron:
  title: "Handle chat interaction with portal visitor"
  tagline: 
...
|---
|-|-
| **Name:** | Handle chat interaction with portal visitor
| **Identifier (ID):** | event.interaction.chat.portal
| **Class:** | Event_NewInteractionChatPortal
| **File:** | features/cerb.bots.portal.widget/api/events/new_interaction_chat_portal.php
...
| Action | ID
|-|-
| [**Use behavior**](/docs/bots/events/event.interaction.chat.portal/actions/switch_behavior/) | `switch_behavior`
