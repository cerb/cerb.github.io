---
title: >-
  Before message sent by worker
permalink: /docs/bots/events/event.mail.before.sent/
toc:
  title: "Before message sent by worker"
  expand: Bots
jumbotron:
  title: "Before message sent by worker"
  tagline: 
...
|---
|-|-
| **Name:** | Before message sent by worker
| **Identifier (ID):** | event.mail.before.sent
| **Class:** | Event_MailBeforeSent
| **File:** | features/cerberusweb.core/api/events/app/mail_before_sent.php
...
| Action | ID
|-|-
| [**Append text to message content**](/docs/bots/events/event.mail.before.sent/actions/append_to_content/) | `append_to_content`
| [**Prepend text to message content**](/docs/bots/events/event.mail.before.sent/actions/prepend_to_content/) | `prepend_to_content`
| [**Replace text in message content**](/docs/bots/events/event.mail.before.sent/actions/replace_content/) | `replace_content`
| [**Set message header**](/docs/bots/events/event.mail.before.sent/actions/set_header/) | `set_header`
| [**Set message send at**](/docs/bots/events/event.mail.before.sent/actions/set_send_at/) | `set_send_at`
