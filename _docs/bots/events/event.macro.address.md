---
title: >-
  Record custom behavior on email address
permalink: /docs/bots/events/event.macro.address/
toc:
  title: "Record custom behavior on email address"
  expand: Bots
jumbotron:
  title: "Record custom behavior on email address"
  tagline: 
...
|---
|-|-
| **Name:** | Record custom behavior on email address
| **Identifier (ID):** | event.macro.address
| **Class:** | Event_AddressMacro
| **File:** | features/cerberusweb.core/api/events/macro/address_macro.php
