...
permalink: /docs/bots/events/event.mail.closed.group/
toc:
  title: "Ticket closed in group"
  expand: Bots
jumbotron:
  title: "Ticket closed in group"
  tagline: 
...
|---
|-|-
| **Name:** | Ticket closed in group
| **Identifier (ID):** | event.mail.closed.group
| **Class:** | Event_MailClosedInGroup
| **File:** | features/cerberusweb.core/api/events/group/mail_closed_in_group.php
...
| Action | ID
|-|-
| [**Add recipients**](/docs/bots/events/event.mail.closed.group/actions/add_recipients/) | `add_recipients`
| [**Move to bucket**](/docs/bots/events/event.mail.closed.group/actions/move_to/) | `move_to`
| [**Remove recipients**](/docs/bots/events/event.mail.closed.group/actions/remove_recipients/) | `remove_recipients`
| [**Send email relay to workers**](/docs/bots/events/event.mail.closed.group/actions/relay_email/) | `relay_email`
| [**Send email to recipients**](/docs/bots/events/event.mail.closed.group/actions/send_email_recipients/) | `send_email_recipients`
| [**Send scheduled email to recipients**](/docs/bots/events/event.mail.closed.group/actions/schedule_email_recipients/) | `schedule_email_recipients`
