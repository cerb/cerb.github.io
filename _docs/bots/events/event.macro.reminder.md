---
title: >-
  Record custom behavior on reminder
permalink: /docs/bots/events/event.macro.reminder/
toc:
  title: "Record custom behavior on reminder"
  expand: Bots
jumbotron:
  title: "Record custom behavior on reminder"
  tagline: 
...
|---
|-|-
| **Name:** | Record custom behavior on reminder
| **Identifier (ID):** | event.macro.reminder
| **Class:** | Event_ReminderMacro
| **File:** | features/cerberusweb.core/api/events/macro/reminder_macro.php
