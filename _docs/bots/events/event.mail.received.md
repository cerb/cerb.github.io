...
permalink: /docs/bots/events/event.mail.received/
toc:
  title: "New message added to ticket"
  expand: Bots
jumbotron:
  title: "New message added to ticket"
  tagline: 
...
|---
|-|-
| **Name:** | New message added to ticket
| **Identifier (ID):** | event.mail.received
| **Class:** | Event_MailReceived
| **File:** | features/cerberusweb.core/api/events/group/mail_received.php
...
| Action | ID
|-|-
| [**Add recipients**](/docs/bots/events/event.mail.received/actions/add_recipients/) | `add_recipients`
| [**Move to bucket**](/docs/bots/events/event.mail.received/actions/move_to/) | `move_to`
| [**Remove recipients**](/docs/bots/events/event.mail.received/actions/remove_recipients/) | `remove_recipients`
| [**Send email relay to workers**](/docs/bots/events/event.mail.received/actions/relay_email/) | `relay_email`
| [**Send email to recipients**](/docs/bots/events/event.mail.received/actions/send_email_recipients/) | `send_email_recipients`
| [**Send scheduled email to recipients**](/docs/bots/events/event.mail.received/actions/schedule_email_recipients/) | `schedule_email_recipients`
