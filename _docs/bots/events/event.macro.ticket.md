---
title: >-
  Record custom behavior on ticket
permalink: /docs/bots/events/event.macro.ticket/
toc:
  title: "Record custom behavior on ticket"
  expand: Bots
jumbotron:
  title: "Record custom behavior on ticket"
  tagline: 
...
|---
|-|-
| **Name:** | Record custom behavior on ticket
| **Identifier (ID):** | event.macro.ticket
| **Class:** | Event_TicketMacro
| **File:** | features/cerberusweb.core/api/events/macro/ticket_macro.php
...
| Action | ID
|-|-
| [**Add recipients**](/docs/bots/events/event.macro.ticket/actions/add_recipients/) | `add_recipients`
| [**Move to bucket**](/docs/bots/events/event.macro.ticket/actions/move_to/) | `move_to`
| [**Remove recipients**](/docs/bots/events/event.macro.ticket/actions/remove_recipients/) | `remove_recipients`
| [**Send email relay to workers**](/docs/bots/events/event.macro.ticket/actions/relay_email/) | `relay_email`
| [**Send email to recipients**](/docs/bots/events/event.macro.ticket/actions/send_email_recipients/) | `send_email_recipients`
| [**Send scheduled email to recipients**](/docs/bots/events/event.macro.ticket/actions/schedule_email_recipients/) | `schedule_email_recipients`
