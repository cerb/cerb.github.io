...
permalink: /docs/bots/events/event.contact.registered.sc/
toc:
  title: "New contact registered in Support Center"
  expand: Bots
jumbotron:
  title: "New contact registered in Support Center"
  tagline: 
...
|---
|-|-
| **Name:** | New contact registered in Support Center
| **Identifier (ID):** | event.contact.registered.sc
| **Class:** | Event_ContactRegisteredInSupportCenter
| **File:** | features/cerberusweb.support_center/api/events/contact_registered_in_sc.php
