...
permalink: /docs/bots/events/event.macro.bot/
toc:
  title: "Record custom behavior on bot"
  expand: Bots
jumbotron:
  title: "Record custom behavior on bot"
  tagline: 
...
|---
|-|-
| **Name:** | Record custom behavior on bot
| **Identifier (ID):** | event.macro.bot
| **Class:** | Event_BotMacro
| **File:** | features/cerberusweb.core/api/events/macro/bot_macro.php
