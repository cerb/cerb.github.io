---
title: >-
  Record custom behavior on feed item
permalink: /docs/bots/events/event.macro.feeditem/
toc:
  title: "Record custom behavior on feed item"
  expand: Bots
jumbotron:
  title: "Record custom behavior on feed item"
  tagline: 
...
|---
|-|-
| **Name:** | Record custom behavior on feed item
| **Identifier (ID):** | event.macro.feeditem
| **Class:** | Event_FeedItemMacro
| **File:** | storage/plugins/cerberusweb.feed_reader/api/events/feeditem_macro.php
