---
title: >-
  Record custom behavior on worker
permalink: /docs/bots/events/event.macro.worker/
toc:
  title: "Record custom behavior on worker"
  expand: Bots
jumbotron:
  title: "Record custom behavior on worker"
  tagline: 
...
|---
|-|-
| **Name:** | Record custom behavior on worker
| **Identifier (ID):** | event.macro.worker
| **Class:** | Event_WorkerMacro
| **File:** | features/cerberusweb.core/api/events/macro/worker_macro.php
