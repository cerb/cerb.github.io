...
permalink: /docs/bots/events/event.macro.group/
toc:
  title: "Record custom behavior on group"
  expand: Bots
jumbotron:
  title: "Record custom behavior on group"
  tagline: 
...
|---
|-|-
| **Name:** | Record custom behavior on group
| **Identifier (ID):** | event.macro.group
| **Class:** | Event_GroupMacro
| **File:** | features/cerberusweb.core/api/events/macro/group_macro.php
