...
permalink: /docs/bots/events/event.mail.moved.group/
toc:
  title: "Ticket moved in group"
  expand: Bots
jumbotron:
  title: "Ticket moved in group"
  tagline: 
...
|---
|-|-
| **Name:** | Ticket moved in group
| **Identifier (ID):** | event.mail.moved.group
| **Class:** | Event_MailMovedToGroup
| **File:** | features/cerberusweb.core/api/events/group/mail_moved_to_group.php
...
| Action | ID
|-|-
| [**Add recipients**](/docs/bots/events/event.mail.moved.group/actions/add_recipients/) | `add_recipients`
| [**Move to bucket**](/docs/bots/events/event.mail.moved.group/actions/move_to/) | `move_to`
| [**Remove recipients**](/docs/bots/events/event.mail.moved.group/actions/remove_recipients/) | `remove_recipients`
| [**Send email relay to workers**](/docs/bots/events/event.mail.moved.group/actions/relay_email/) | `relay_email`
| [**Send email to recipients**](/docs/bots/events/event.mail.moved.group/actions/send_email_recipients/) | `send_email_recipients`
| [**Send scheduled email to recipients**](/docs/bots/events/event.mail.moved.group/actions/schedule_email_recipients/) | `schedule_email_recipients`
