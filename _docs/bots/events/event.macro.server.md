---
title: >-
  Record custom behavior on server
permalink: /docs/bots/events/event.macro.server/
toc:
  title: "Record custom behavior on server"
  expand: Bots
jumbotron:
  title: "Record custom behavior on server"
  tagline: 
...
|---
|-|-
| **Name:** | Record custom behavior on server
| **Identifier (ID):** | event.macro.server
| **Class:** | Event_ServerMacro
| **File:** | storage/plugins/cerberusweb.datacenter.servers/api/events/server_macro.php
