---
title: >-
  Ticket profile viewed by a worker
permalink: /docs/bots/events/event.ticket.viewed.worker/
toc:
  title: "Ticket profile viewed by a worker"
  expand: Bots
jumbotron:
  title: "Ticket profile viewed by a worker"
  tagline: 
...
|---
|-|-
| **Name:** | Ticket profile viewed by a worker
| **Identifier (ID):** | event.ticket.viewed.worker
| **Class:** | Event_TicketViewedByWorker
| **File:** | features/cerberusweb.core/api/events/app/ticket_viewed_by_worker.php
...
| Action | ID
|-|-
| [**Add recipients**](/docs/bots/events/event.ticket.viewed.worker/actions/add_recipients/) | `add_recipients`
| [**Move to bucket**](/docs/bots/events/event.ticket.viewed.worker/actions/move_to/) | `move_to`
| [**Remove recipients**](/docs/bots/events/event.ticket.viewed.worker/actions/remove_recipients/) | `remove_recipients`
| [**Send email relay to workers**](/docs/bots/events/event.ticket.viewed.worker/actions/relay_email/) | `relay_email`
| [**Send email to recipients**](/docs/bots/events/event.ticket.viewed.worker/actions/send_email_recipients/) | `send_email_recipients`
| [**Send scheduled email to recipients**](/docs/bots/events/event.ticket.viewed.worker/actions/schedule_email_recipients/) | `schedule_email_recipients`
