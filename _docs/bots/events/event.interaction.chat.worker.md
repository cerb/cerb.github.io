...
permalink: /docs/bots/events/event.interaction.chat.worker/
toc:
  title: "Handle chat interaction with worker"
  expand: Bots
jumbotron:
  title: "Handle chat interaction with worker"
  tagline: 
...
|---
|-|-
| **Name:** | Handle chat interaction with worker
| **Identifier (ID):** | event.interaction.chat.worker
| **Class:** | Event_NewInteractionChatWorker
| **File:** | features/cerberusweb.core/api/events/interaction/new_interaction_chat_worker.php
...
| Action | ID
|-|-
| [**Set bot name**](/docs/bots/events/event.interaction.chat.worker/actions/set_bot_name/) | `set_bot_name`
| [**Use behavior**](/docs/bots/events/event.interaction.chat.worker/actions/switch_behavior/) | `switch_behavior`
