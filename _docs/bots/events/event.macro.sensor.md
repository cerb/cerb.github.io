---
title: >-
  Record custom behavior on sensor
permalink: /docs/bots/events/event.macro.sensor/
toc:
  title: "Record custom behavior on sensor"
  expand: Bots
jumbotron:
  title: "Record custom behavior on sensor"
  tagline: 
...
|---
|-|-
| **Name:** | Record custom behavior on sensor
| **Identifier (ID):** | event.macro.sensor
| **Class:** | Event_SensorMacro
| **File:** | storage/plugins/cerberusweb.datacenter.sensors/api/events/sensor_macro.php
