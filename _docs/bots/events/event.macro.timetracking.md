---
title: >-
  Record custom behavior on time tracking entry
permalink: /docs/bots/events/event.macro.timetracking/
toc:
  title: "Record custom behavior on time tracking entry"
  expand: Bots
jumbotron:
  title: "Record custom behavior on time tracking entry"
  tagline: 
...
|---
|-|-
| **Name:** | Record custom behavior on time tracking entry
| **Identifier (ID):** | event.macro.timetracking
| **Class:** | Event_TimeTrackingMacro
| **File:** | features/cerberusweb.timetracking/api/events/timetracking_macro.php
