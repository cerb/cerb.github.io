---
title: >-
  Record custom behavior on notification
permalink: /docs/bots/events/event.macro.notification/
toc:
  title: "Record custom behavior on notification"
  expand: Bots
jumbotron:
  title: "Record custom behavior on notification"
  tagline: 
...
|---
|-|-
| **Name:** | Record custom behavior on notification
| **Identifier (ID):** | event.macro.notification
| **Class:** | Event_NotificationMacro
| **File:** | features/cerberusweb.core/api/events/macro/notification_macro.php
...
| Action | ID
|-|-
| [**Copy notification**](/docs/bots/events/event.macro.notification/actions/copy_notification/) | `copy_notification`
