---
title: >-
  Record custom behavior on calendar
permalink: /docs/bots/events/event.macro.calendar/
toc:
  title: "Record custom behavior on calendar"
  expand: Bots
jumbotron:
  title: "Record custom behavior on calendar"
  tagline: 
...
|---
|-|-
| **Name:** | Record custom behavior on calendar
| **Identifier (ID):** | event.macro.calendar
| **Class:** | Event_CalendarMacro
| **File:** | features/cerberusweb.core/api/events/macro/calendar_macro.php
