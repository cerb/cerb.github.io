---
title: >-
  Respond to Ajax HTTP request
permalink: /docs/bots/events/event.ajax.request/
toc:
  title: "Respond to Ajax HTTP request"
  expand: Bots
jumbotron:
  title: "Respond to Ajax HTTP request"
  tagline: 
...
|---
|-|-
| **Name:** | Respond to Ajax HTTP request
| **Identifier (ID):** | event.ajax.request
| **Class:** | Event_AjaxHttpRequest
| **File:** | features/cerberusweb.core/api/events/ajax/ajax_request.php
...
| Action | ID
|-|-
| [**Respond with HTTP body**](/docs/bots/events/event.ajax.request/actions/set_http_body/) | `set_http_body`
| [**Respond with HTTP header**](/docs/bots/events/event.ajax.request/actions/set_http_header/) | `set_http_header`
| [**Respond with HTTP status**](/docs/bots/events/event.ajax.request/actions/set_http_status/) | `set_http_status`
| [**Set timezone**](/docs/bots/events/event.ajax.request/actions/set_timezone/) | `set_timezone`
