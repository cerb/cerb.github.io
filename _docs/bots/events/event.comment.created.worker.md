...
title: >-
  Record commented on
permalink: /docs/bots/events/event.comment.created.worker/
toc:
  title: "Record commented on"
  expand: Bots
jumbotron:
  title: "Record commented on"
  tagline: 
...
|---
|-|-
| **Name:** | Record commented on
| **Identifier (ID):** | event.comment.created.worker
| **Class:** | Event_CommentCreatedByWorker
| **File:** | features/cerberusweb.core/api/events/app/comment_created_by_worker.php
