---
title: >-
  Record worklist rendered
permalink: /docs/bots/events/event.ui.worklist.render.worker/
toc:
  title: "Record worklist rendered"
  expand: Bots
jumbotron:
  title: "Record worklist rendered"
  tagline: 
...
|---
|-|-
| **Name:** | Record worklist rendered
| **Identifier (ID):** | event.ui.worklist.render.worker
| **Class:** | Event_UiWorklistRenderByWorker
| **File:** | features/cerberusweb.core/api/events/ui/ui_worklist_render_by_worker.php
...
| Action | ID
|-|-
| [**Execute jQuery script**](/docs/bots/events/event.ui.worklist.render.worker/actions/exec_jquery/) | `exec_jquery`
