...
title: >-
  New task created
permalink: /docs/bots/events/event.task.created.worker/
toc:
...
| **Identifier (ID):** | event.task.created.worker
| **Class:** | Event_TaskCreatedByWorker
| **File:** | features/cerberusweb.core/api/events/app/task_created_by_worker.php
