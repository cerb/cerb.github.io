---
title: >-
  Record custom behavior on task
permalink: /docs/bots/events/event.macro.task/
toc:
  title: "Record custom behavior on task"
  expand: Bots
jumbotron:
  title: "Record custom behavior on task"
  tagline: 
...
|---
|-|-
| **Name:** | Record custom behavior on task
| **Identifier (ID):** | event.macro.task
| **Class:** | Event_TaskMacro
| **File:** | features/cerberusweb.core/api/events/macro/task_macro.php
