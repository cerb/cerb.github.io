---
title: >-
  Record editor opened
permalink: /docs/bots/events/event.ui.card.editor.opened.worker/
toc:
  title: "Record editor opened"
  expand: Bots
jumbotron:
  title: "Record editor opened"
  tagline: 
...
|---
|-|-
| **Name:** | Record editor opened
| **Identifier (ID):** | event.ui.card.editor.opened.worker
| **Class:** | Event_UiCardEditorOpenedByWorker
| **File:** | features/cerberusweb.core/api/events/ui/ui_card_editor_opened_by_worker.php
...
| Action | ID
|-|-
| [**Execute jQuery script**](/docs/bots/events/event.ui.card.editor.opened.worker/actions/exec_jquery/) | `exec_jquery`
