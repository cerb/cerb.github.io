...
permalink: /docs/bots/events/event.data.query.datasource/
toc:
  title: "Data query datasource"
  expand: Bots
jumbotron:
  title: "Data query datasource"
  tagline: 
...
|---
|-|-
| **Name:** | Data query datasource
| **Identifier (ID):** | event.data.query.datasource
| **Class:** | Event_DataQueryDatasource
| **File:** | features/cerberusweb.core/api/events/datasource/data_query_datasource.php
...
| Action | ID
|-|-
| [**Return data**](/docs/bots/events/event.data.query.datasource/actions/return_data/) | `return_data`
