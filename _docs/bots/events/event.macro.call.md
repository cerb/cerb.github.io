...
permalink: /docs/bots/events/event.macro.call/
toc:
  title: "Record custom behavior on call"
  expand: Bots
jumbotron:
  title: "Record custom behavior on call"
  tagline: 
...
|---
|-|-
| **Name:** | Record custom behavior on call
| **Identifier (ID):** | event.macro.call
| **Class:** | Event_CallMacro
| **File:** | storage/plugins/cerberusweb.calls/api/events/macro/call_macro.php
