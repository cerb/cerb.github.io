...
permalink: /docs/bots/events/event.notification.received.worker/
toc:
  title: "New notification for me"
  expand: Bots
jumbotron:
  title: "New notification for me"
  tagline: 
...
|---
|-|-
| **Name:** | New notification for me
| **Identifier (ID):** | event.notification.received.worker
| **Class:** | Event_NotificationReceivedByWorker
| **File:** | features/cerberusweb.core/api/events/worker/notification_received_by_worker.php
...
| Action | ID
|-|-
| [**Mark read**](/docs/bots/events/event.notification.received.worker/actions/mark_read/) | `mark_read`
| [**Send email to notified worker**](/docs/bots/events/event.notification.received.worker/actions/send_email_owner/) | `send_email_owner`
