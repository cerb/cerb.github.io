---
title: >-
  Get chat interactions for worker
permalink: /docs/bots/events/event.interactions.get.worker/
toc:
  title: "Get chat interactions for worker"
  expand: Bots
jumbotron:
  title: "Get chat interactions for worker"
  tagline: 
...
|---
|-|-
| **Name:** | Get chat interactions for worker
| **Identifier (ID):** | event.interactions.get.worker
| **Class:** | Event_GetInteractionsForWorker
| **File:** | features/cerberusweb.core/api/events/interaction/get_interactions_for_worker.php
...
| Action | ID
|-|-
| [**Return interaction**](/docs/bots/events/event.interactions.get.worker/actions/return_interaction/) | `return_interaction`
