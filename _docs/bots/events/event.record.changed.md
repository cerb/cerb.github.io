...
title: >-
  Record changed
permalink: /docs/bots/events/event.record.changed/
toc:
...
|-|-
| **Name:** | Record changed
| **Identifier (ID):** | event.record.changed
| **Class:** | Event_RecordChanged
| **File:** | features/cerberusweb.core/api/events/app/record_changed.php
