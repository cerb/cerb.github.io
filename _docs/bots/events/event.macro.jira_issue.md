---
title: >-
  Record custom behavior on JIRA issue
permalink: /docs/bots/events/event.macro.jira_issue/
toc:
  title: "Record custom behavior on JIRA issue"
  expand: Bots
jumbotron:
  title: "Record custom behavior on JIRA issue"
  tagline: 
...
|---
|-|-
| **Name:** | Record custom behavior on JIRA issue
| **Identifier (ID):** | event.macro.jira_issue
| **Class:** | Event_JiraIssueMacro
| **File:** | storage/plugins/wgm.jira/api/events/jira_issue_macro.php
