...
permalink: /docs/bots/events/event.comment.ticket.group/
toc:
  title: "New comment on ticket in group"
  expand: Bots
jumbotron:
  title: "New comment on ticket in group"
  tagline: 
...
|---
|-|-
| **Name:** | New comment on ticket in group
| **Identifier (ID):** | event.comment.ticket.group
| **Class:** | Event_CommentOnTicketInGroup
| **File:** | features/cerberusweb.core/api/events/group/comment_on_ticket_in_group.php
...
| Action | ID
|-|-
| [**Add recipients**](/docs/bots/events/event.comment.ticket.group/actions/add_recipients/) | `add_recipients`
| [**Move to bucket**](/docs/bots/events/event.comment.ticket.group/actions/move_to/) | `move_to`
| [**Remove recipients**](/docs/bots/events/event.comment.ticket.group/actions/remove_recipients/) | `remove_recipients`
| [**Send email relay to workers**](/docs/bots/events/event.comment.ticket.group/actions/relay_email/) | `relay_email`
| [**Send email to recipients**](/docs/bots/events/event.comment.ticket.group/actions/send_email_recipients/) | `send_email_recipients`
| [**Send scheduled email to recipients**](/docs/bots/events/event.comment.ticket.group/actions/schedule_email_recipients/) | `schedule_email_recipients`
