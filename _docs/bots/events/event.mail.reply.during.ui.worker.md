---
title: >-
  [DEPRECATED] During a message reply
permalink: /docs/bots/events/event.mail.reply.during.ui.worker/
toc:
  title: "[DEPRECATED] During a message reply"
  expand: Bots
jumbotron:
  title: "[DEPRECATED] During a message reply"
  tagline: 
...
|---
|-|-
| **Name:** | [DEPRECATED] During a message reply
| **Identifier (ID):** | event.mail.reply.during.ui.worker
| **Class:** | Event_MailDuringUiReplyByWorker
| **File:** | features/cerberusweb.core/api/events/ui/ui_during_reply_by_worker.php
...
| Action | ID
|-|-
| [**Execute jQuery script**](/docs/bots/events/event.mail.reply.during.ui.worker/actions/exec_jquery/) | `exec_jquery`
