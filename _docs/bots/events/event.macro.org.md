...
permalink: /docs/bots/events/event.macro.org/
toc:
  title: "Record custom behavior on organization"
  expand: Bots
jumbotron:
  title: "Record custom behavior on organization"
  tagline: 
...
|---
|-|-
| **Name:** | Record custom behavior on organization
| **Identifier (ID):** | event.macro.org
| **Class:** | Event_OrgMacro
| **File:** | features/cerberusweb.core/api/events/macro/org_macro.php
