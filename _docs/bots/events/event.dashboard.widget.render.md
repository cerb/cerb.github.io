---
title: >-
  Dashboard render widget
permalink: /docs/bots/events/event.dashboard.widget.render/
toc:
  title: "Dashboard render widget"
  expand: Bots
jumbotron:
  title: "Dashboard render widget"
  tagline: 
...
|---
|-|-
| **Name:** | Dashboard render widget
| **Identifier (ID):** | event.dashboard.widget.render
| **Class:** | Event_DashboardWidgetRender
| **File:** | features/cerberusweb.core/api/events/dashboards/dashboard_widget_render.php
...
| Action | ID
|-|-
| [**Render HTML**](/docs/bots/events/event.dashboard.widget.render/actions/render_html/) | `render_html`
