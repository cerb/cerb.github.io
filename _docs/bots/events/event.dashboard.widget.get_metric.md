---
title: >-
  Dashboard get metric for widget
permalink: /docs/bots/events/event.dashboard.widget.get_metric/
toc:
  title: "Dashboard get metric for widget"
  expand: Bots
jumbotron:
  title: "Dashboard get metric for widget"
  tagline: 
...
|---
|-|-
| **Name:** | Dashboard get metric for widget
| **Identifier (ID):** | event.dashboard.widget.get_metric
| **Class:** | Event_DashboardWidgetGetMetric
| **File:** | features/cerberusweb.core/api/events/dashboards/dashboard_widget_get_metric.php
...
| Action | ID
|-|-
| [**Return metric value**](/docs/bots/events/event.dashboard.widget.get_metric/actions/return_value/) | `return_value`
