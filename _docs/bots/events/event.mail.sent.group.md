...
permalink: /docs/bots/events/event.mail.sent.group/
toc:
  title: "Before message sent by group member"
  expand: Bots
jumbotron:
  title: "Before message sent by group member"
  tagline: 
...
|---
|-|-
| **Name:** | Before message sent by group member
| **Identifier (ID):** | event.mail.sent.group
| **Class:** | Event_MailBeforeSentByGroup
| **File:** | features/cerberusweb.core/api/events/group/mail_before_sent_by_group.php
...
| Action | ID
|-|-
| [**Append text to message content**](/docs/bots/events/event.mail.sent.group/actions/append_to_content/) | `append_to_content`
