---
title: >-
  Record custom behavior on opportunity
permalink: /docs/bots/events/event.macro.crm.opportunity/
toc:
  title: "Record custom behavior on opportunity"
  expand: Bots
jumbotron:
  title: "Record custom behavior on opportunity"
  tagline: 
...
|---
|-|-
| **Name:** | Record custom behavior on opportunity
| **Identifier (ID):** | event.macro.crm.opportunity
| **Class:** | Event_CrmOpportunityMacro
| **File:** | features/cerberusweb.crm/api/events/opportunity_macro.php
