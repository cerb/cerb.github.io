...
permalink: /docs/bots/events/event.mail.reply.pre.ui.worker/
toc:
  title: "Before composing a message reply"
  expand: Bots
jumbotron:
  title: "Before composing a message reply"
  tagline: 
...
|---
|-|-
| **Name:** | Before composing a message reply
| **Identifier (ID):** | event.mail.reply.pre.ui.worker
| **Class:** | Event_MailBeforeUiReplyByWorker
| **File:** | features/cerberusweb.core/api/events/ui/ui_before_reply_by_worker.php
...
| Action | ID
|-|-
| [**Execute jQuery script**](/docs/bots/events/event.mail.reply.pre.ui.worker/actions/exec_jquery/) | `exec_jquery`
