...
permalink: /docs/bots/events/event.mail.received.watcher/
toc:
  title: "New message on a watched ticket"
  expand: Bots
jumbotron:
  title: "New message on a watched ticket"
  tagline: 
...
|---
|-|-
| **Name:** | New message on a watched ticket
| **Identifier (ID):** | event.mail.received.watcher
| **Class:** | Event_MailReceivedByWatcher
| **File:** | features/cerberusweb.core/api/events/worker/mail_received_by_watcher.php
...
| Action | ID
|-|-
| [**Send email relay to workers**](/docs/bots/events/event.mail.received.watcher/actions/relay_email/) | `relay_email`
| [**Send email to recipients**](/docs/bots/events/event.mail.received.watcher/actions/send_email_recipients/) | `send_email_recipients`
