...
| Action | ID
|-|-
| [**Relay to external email**](/docs/bots/events/event.mail.received.watcher/actions/relay_email/) | `relay_email`
| [**Reply to recipients**](/docs/bots/events/event.mail.received.watcher/actions/send_email_recipients/) | `send_email_recipients`
