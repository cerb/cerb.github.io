---
title: >-
  Record custom behavior on calendar event
permalink: /docs/bots/events/event.macro.calendar_event/
toc:
  title: "Record custom behavior on calendar event"
  expand: Bots
jumbotron:
  title: "Record custom behavior on calendar event"
  tagline: 
...
|---
|-|-
| **Name:** | Record custom behavior on calendar event
| **Identifier (ID):** | event.macro.calendar_event
| **Class:** | Event_CalendarEventMacro
| **File:** | features/cerberusweb.core/api/events/macro/calendar_event_macro.php
