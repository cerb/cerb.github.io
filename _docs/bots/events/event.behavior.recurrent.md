...
title: >-
  Recurrent behavior
permalink: /docs/bots/events/event.behavior.recurrent/
toc:
  title: "Recurrent behavior"
  expand: Bots
jumbotron:
  title: "Recurrent behavior"
  tagline: 
...
|---
|-|-
| **Name:** | Recurrent behavior
| **Identifier (ID):** | event.behavior.recurrent
| **Class:** | Event_RecurrentBehavior
| **File:** | features/cerberusweb.core/api/events/recurrent/recurrent_behavior.php
