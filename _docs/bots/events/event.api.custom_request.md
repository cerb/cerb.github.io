...
title: >-
  Custom API request
permalink: /docs/bots/events/event.api.custom_request/
toc:
...
| **Identifier (ID):** | event.api.custom_request
| **Class:** | Event_ApiRequest
| **File:** | features/cerberusweb.core/api/events/api/api_request.php
...
| Action | ID
|-|-
| [**Add to API response message**](/docs/bots/events/event.api.custom_request/actions/add_api_response/) | `add_api_response`
