...
permalink: /docs/bots/events/event.macro.contact/
toc:
  title: "Record custom behavior on contact"
  expand: Bots
jumbotron:
  title: "Record custom behavior on contact"
  tagline: 
...
|---
|-|-
| **Name:** | Record custom behavior on contact
| **Identifier (ID):** | event.macro.contact
| **Class:** | Event_ContactMacro
| **File:** | features/cerberusweb.core/api/events/macro/contact_macro.php
