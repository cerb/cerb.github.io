---
title: Memcached
excerpt: How to set up Memcached caching to improve performance and scalability.
summary: This guide provides instructions for configuring Memcached
  as a caching solution using Docker containers. Learn how to set up
  a basic Memcached container and configure Cerb to use it through the Memcached
  interface for improved application performance.
topic: Scaling
jumbotron:
  title: Memcached
  breadcrumbs:
...
<img src="/assets/images/docs/scaling/cache/memcached-config.png" class="screenshot">
</div>

Once connected, Cerb will show: Objects are cached in **Memcached** at **host.docker.internal:11211**

<div class="cerb-screenshot">
<img src="/assets/images/docs/scaling/cache/memcached-running.png" class="screenshot">
</div>
...
<div class="cerb-screenshot">
<img src="/assets/images/docs/scaling/cache/memcached-cli.png" class="screenshot">
</div>

# References

[^memcached]: Memcached: dockerhub - <https://hub.docker.com/_/memcached>