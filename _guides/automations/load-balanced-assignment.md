...
excerpt: This page provides a guide on implementing load-balanced assignment in Cerb using automations, covering both round-robin and least-loaded approaches.
...
permalink: /guides/automations/load-balanced-assignment/
layout: integration
topic: Automations
jumbotron:
  title: Load-balanced assignment
