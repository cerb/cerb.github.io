---
title: 10.0.5
excerpt: Cerb 10.0.5 is a maintenance update released in July 2021 with 9 minor features
  and fixes from community feedback.
summary: This page details the Cerb 10.0.5 maintenance update released on July 21,
  2021, which includes nine minor features and fixes based on community feedback from
  the 10.0 update. Key improvements include adjustments to connected account records,
  automation scripting, ticket attachments, and bot behaviors. Specific issues addressed
  involve the URI field in connected accounts, error handling in automation logs,
  attachment menu functionality in ticket profiles, and proper documentation links
  in the Automation Event editor. Additionally, the update resolves issues with knowledgebase
  RSS feeds in the Support Center, workspace page access errors, and visual glitches
  on project boards when using the Brave browser. The update also enhances automation
  scripting with new autocompletion suggestions.
layout: post
