---
title: 10.1.2
excerpt: Cerb 10.1.2 is a maintenance update released in September 2021 with 17 minor
  features and fixes from community feedback.
summary: This page details the Cerb 10.1.2 maintenance update released on September
  29, 2021, which includes 17 minor features and fixes based on community feedback
  from the 10.1 update. Key improvements include fixes in automation validation, enhancements
  in automation scripting with new filters for string manipulation, and updates to
  sheet widgets and record handling. The update also addresses issues with profile
  image fetching for ticket and bucket records, improves data query sorting, and enhances
  user experience in interaction automations. Additionally, it introduces new options
  for displaying record profile images in sheets and enables Markdown formatting in
  bot behavior comments.
layout: post
