...
excerpt: Cerb 10.2 is a major feature update in development during December 2021 with 87 improvements from community feedback.
...
* **[Data Queries]** Added a new `automation.autocomplete` data query that returns autocompletion suggestions data for a given automation key path. This can be used by functionality like interactions to inspect an automation at the current cursor to offer contextual suggestions.
