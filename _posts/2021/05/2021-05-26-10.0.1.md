---
title: 10.0.1
excerpt: Cerb 10.0.1 is a maintenance update released in May 2021 with 13 minor features
  and fixes from community feedback.
summary: This page details the Cerb 10.0.1 maintenance update released on May 26,
  2021, which includes 13 minor features and fixes based on community feedback from
  the 10.0 update. Key updates include enhancements to webhook portals with `webhook.respond`
  automations, improvements in mail HTML templates with a new `message_token` placeholder,
  and various fixes in the automations editor. Additional updates address issues in
  draft record dictionaries, mail compose and reply editors, toolbar editors, and
  resource storage management. The update also improves website interactions and user
  experience in the automation editor with enhanced autocompletion features.
layout: post
