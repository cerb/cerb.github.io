---
title: 10.0.3
excerpt: Cerb 10.0.3 is a maintenance update released in June 2021 with 8 minor features
  and fixes from community feedback.
summary: This page details the Cerb 10.0.3 maintenance update released on June 07,
  2021, which includes eight minor features and fixes based on community feedback
  from the 10.0 update. Key improvements include enhancements to automation scripting
  with a new `|append` filter, fixes to automation event records affecting card and
  profile widgets, and corrections to human-readable duration formatting. Additional
  updates address issues with draft dictionaries, custom fieldset creation by non-admin
  workers, record search queries, interaction automation paging, and usability improvements
