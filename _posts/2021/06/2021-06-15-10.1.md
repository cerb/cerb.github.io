...
excerpt: Cerb 10.1 is a major feature update in development during June 2021 with 50 improvements from community feedback.
...
* **[Plugins]** Reintroduced a 'Download All Record Attachments' plugin. This adds a new 'Files' tab type on ticket profiles. The tab displays all of the attachments linked to the ticket, its messages, and its comments. A 'Download all (.zip)' button creates a single ZIP archive with the combined attachments and downloads it.
