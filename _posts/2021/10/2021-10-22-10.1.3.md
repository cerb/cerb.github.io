---
title: 10.1.3
excerpt: Cerb 10.1.3 is a maintenance update released in October 2021 with 11 minor
  features and fixes from community feedback.
summary: This page details the release notes for Cerb version 10.1.3, a maintenance
  update launched on October 25, 2021. It highlights 11 minor features and fixes based
  on community feedback from the 10.1 update. Key improvements include resolving issues
  with data query timeouts, validation in automations, user experience enhancements
  in sheets and dashboards, and interaction automation adjustments. Additionally,
  it addresses search query issues, knowledgebase exploration, and automation triggers
  related to record changes and comments. The update also ensures that ticket drafts
  that fail to deliver automatically reopen the ticket, preventing unnoticed 'waiting'
  statuses. The page provides instructions for upgrading to this version.
layout: post
