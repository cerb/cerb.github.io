---
title: 8.2.10
excerpt: Cerb 8.2.10 is a maintenance update released in February 2018 with 19 minor
  features and fixes from community feedback.
summary: This page details the release notes for Cerb version 8.2.10, a maintenance
  update launched on February 26, 2018. The update includes 19 minor features and
  fixes based on community feedback from the 8.2 update. Key improvements include
  enhancements to group cards, dashboard chart widgets, worker profile management,
  and usability in setting bucket responsibilities. The update also addresses several
  security issues, such as potential XSS vulnerabilities in attachments and organization
  records, and introduces measures to prevent brute force login attempts. Additionally,
  it fixes issues related to plugin registration, template caching, worklist customizations,
  and URL validation in records. The update aims to improve the overall functionality,
