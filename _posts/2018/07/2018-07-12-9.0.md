...
Added a `worklist.timeseries` type to data queries. This returns time-based data from any worklist (e.g. tickets created by month by status). Multiple data series can be returned in a single query.
