---
title: 9.0.4
excerpt: Cerb 9.0.4 is a maintenance update released in September 2018 with 32 minor
  features and fixes from community feedback.
summary: This page details the release notes for Cerb version 9.0.4, a maintenance
  update released on September 7, 2018. The update includes 32 minor features and
  fixes based on community feedback from the 9.0 update. Key improvements include
  enhancements to the data query testing process, usability improvements for dashboard
  widgets, and fixes for various user interface and functionality issues across profiles,
  tickets, and bots. The update also addresses issues with file uploads, time tracking,
  and worklist search queries, and introduces new features such as customizable filters
  on dashboards and improved bot export functionality. Additionally, several user
  experience enhancements are made for mobile devices and popups, and new data providers
  are added for demonstrating chart widgets.
layout: post
