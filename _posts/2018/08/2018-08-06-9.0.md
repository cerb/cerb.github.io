---
title: "9.0"
excerpt: Cerb 9.0 is a generational major feature update released in August 2018 with
  175 improvements from community feedback.
summary: This page details the release of Cerb 9.0, a significant platform upgrade
  launched on August 6, 2018, featuring over 175 new enhancements and community-driven
  improvements. Key updates include customizable record profiles with flexible and
  responsive dashboards, a variety of new dashboard widgets, and enhanced mobile responsiveness.
  The release introduces a new data query service for efficient data retrieval and
  visualization, replacing legacy reports and improving bot integration. Workspaces
  have been made more dynamic with responsive dashboards and new widget types. The
  mail system now supports reply popups and HTML message previews. The update also
  includes improvements in file uploads, bot scripting, and quick search functionalities.
  Additionally, the platform now supports user-defined stylesheets and optimized performance
  for HTML sanitization. The release notes emphasize the importance of making backups
  before upgrading and highlight the requirement for PHP 7.0+ and MySQL 5.6+.
layout: post
