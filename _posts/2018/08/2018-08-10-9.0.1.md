---
title: 9.0.1
excerpt: Cerb 9.0.1 is a maintenance update released in August 2018 with 23 minor
...
summary: This page details the release of Cerb version 9.0.1, a maintenance update
  launched on August 10, 2018, which addresses 23 minor features and fixes based on
  community feedback from the 9.0 update. Key improvements include enhancements in
  worklist performance, security, and usability, such as optimized bulk updates, refined
  permission checks, and improved filtering options. The update also introduces changes
  to worker profiles, mail routing rules, and project board performance. Additionally,
  it addresses inefficiencies in data queries and dashboard operations, ensuring more
  efficient handling of worklists and reducing unnecessary database queries. Overall,
  the update focuses on refining user experience and system performance.
layout: post
