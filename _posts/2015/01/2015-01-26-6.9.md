---
title: "6.9"
excerpt: Cerb 6.9 is a major feature update released in January 2015 with 90+ new
  features and improvements from community feedback.
summary: This page details the release of Cerb 6.9, a feature upgrade launched on
  January 26, 2015, which includes over 90 new features and improvements based on
  community feedback. Key highlights include enhanced webhook listeners allowing Virtual
  Attendants and plugins to respond to webhooks, a more intelligent quick search feature
  with new fulltext indexes, and the addition of Elasticsearch support for improved
  search indexing. The update also introduces significant enhancements to Virtual
  Attendants, such as access to worker localization and primary calendars, improved
  scripting capabilities, and custom message behaviors. Profiles now summarize record
  links at the top, and new fields have been added to worker profiles. The release
  also covers improvements in mail handling, localization, and the Web API, including
  automatic localization and quick search capabilities. The platform has been updated
  with new dependencies and usability improvements, and several maintenance updates
  (6.9.1 to 6.9.4) address minor features, fixes, and usability enhancements. The
  page also provides instructions for upgrading and checking license eligibility for
  the update.
layout: post
