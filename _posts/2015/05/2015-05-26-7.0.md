---
title: "7.0"
excerpt: Cerb 7.0 is a major feature update released in May 2015 with 110+ new features
...
summary: This page details the release of Cerb 7.0, a major feature upgrade launched
  on May 26, 2015, which introduces over 110 new features and improvements based on
  community feedback. The release emphasizes personalization and machine learning,
  aiming to enhance workflow efficiency and reduce worker collisions in enterprise
  environments. Key updates include configurable bucket responsibilities, a recommendation
  system for assigning tasks, and improved worklist customization. The update also
  introduces public and private group settings, multiple mail transport configurations,
  and a new importance field for ticket records. Additionally, the release enhances
  user interface aesthetics, performance, and security, while providing new development
  tools such as a unit testing framework and support for writer/reader database connections.
  The page also includes important release notes, configuration changes, and instructions
  for upgrading.
layout: post
