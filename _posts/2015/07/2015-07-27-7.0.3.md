---
title: 7.0.3
excerpt: Cerb 7.0.3 is a maintenance update released in July 2015 with 20 fixes and
  minor features from community feedback.
summary: This page details the release notes for Cerb version 7.0.3, a maintenance
  update released on July 27, 2015. The update includes 20 improvements based on community
  feedback from the 7.0 update. Key enhancements include usability improvements in
  ticket profiles and worklists, fixes for Virtual Attendants and scheduler jobs,
  and optimizations for displaying HTML messages. The update addresses issues such
  as default column displays in worklists, proper handling of custom fields in Virtual
  Attendants, and improvements in the import scheduler job. Additionally, it resolves
  problems with the 'round robin' worker assignment in Virtual Attendants and optimizes
  memory usage for complex HTML messages. The update also ensures proper deletion
  of worker-owned calendars and corrects issues with upgrading from earlier versions.
layout: post
