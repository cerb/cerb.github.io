---
title: 7.0.5
excerpt: Cerb 7.0.5 is a maintenance update released in September 2015 with 19 fixes
  and minor features from community feedback.
summary: This page details the release notes for Cerb version 7.0.5, a maintenance
  update launched on September 2, 2015. The update includes 19 improvements based
  on community feedback from the 7.0 version. Key enhancements address issues such
  as exporting records from worklists, fixing a potential cross-site scripting vulnerability,
  and improving the Web-API for knowledgebase articles. Other fixes include resolving
  SQL errors during upgrades, correcting installer issues, enhancing notification
  displays, and improving usability in worklists and reports. The update also addresses
  various bugs related to group management, API calls, contact situations in the Support
  Center, activity log filtering, and mailbox setup. Additionally, it introduces keyboard
  shortcuts for the mail compose popup to enhance user efficiency.
layout: post
