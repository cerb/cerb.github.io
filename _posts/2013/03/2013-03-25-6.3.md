---
title: "6.3"
excerpt: Cerb 6.3 is a major feature update released in March 2013 with 64+ new features
  and improvements from community feedback.
summary: This page details the release of Cerb version 6.3, a feature upgrade launched
  on March 25, 2013, which includes over 64 new features and improvements based on
  community feedback. Key enhancements include changes to third-party plugins, mail
  usability, and virtual attendants with improved behavior statistics, conditions,
  actions, and new comment events. The update also introduces enhancements to workspaces,
  including calendars and worklists, and improvements in security, snippets, tasks,
  quick search, broadcast, comments, contacts, and the Web-API. The platform has been
  optimized for performance and scalability, and plugin development has been enhanced.
  Maintenance updates 6.3.1 and 6.3.2 address minor fixes and usability enhancements.
  The page also provides instructions for upgrading and checking license eligibility
  for the update.
layout: post
