...
excerpt: Cerb 10.2 is a major feature update in development during February 2022 with 166 improvements from community feedback.
...
* **[Profiles/Comments]** On profiles, one or more comments can now be pinned to the top of the conversation. This makes it easier to share a summary or todo list for tickets and tasks. Thanks to [Advance Local](https://advancelocal.com/) for the feature request.
...
* **[Records/Tickets]** On the ticket record editor popup, a `Shift+Enter` keyboard shortcut automatically focuses the 'Save Changes' button. Thanks to Kent at [Flexibits](https://flexibits.com/) for the feature request.
