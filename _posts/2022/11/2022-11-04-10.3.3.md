---
title: 10.3.3
excerpt: Cerb 10.3.3 is a maintenance update released in November 2022 with 9 improvements
  from community feedback.
summary: This page details the Cerb 10.3.3 maintenance update released on November
  4, 2022, which includes nine minor features and fixes based on community feedback
  from the 10.3 update. Key additions include new formatting options for Chart KATA
  widgets, enhanced data export capabilities for sheet widgets, and improved security
  for sensitive information input in worker interactions. Changes involve default
  settings for sheet column parameters and improved user experience for worklist customization.
  Fixes address issues in the automation editor's autocompletion, Chart KATA's category
  axis handling, and click-to-search functionality.
layout: post
