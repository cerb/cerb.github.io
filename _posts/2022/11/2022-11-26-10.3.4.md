---
title: 10.3.4
excerpt: Cerb 10.3.4 is a maintenance update released in November 2022 with 15 improvements
  from community feedback.
summary: This page details the release notes for Cerb version 10.3.4, a maintenance
  update released on November 26, 2022. It highlights 15 minor features and fixes
  based on community feedback from the 10.3 update. Key additions include enhancements
  to Chart KATA widgets, such as new tooltip options and legend styles, and improvements
  in performance and user interface elements like profile avatars and popups. The
  update also addresses several bugs, including issues with mail drafts, data queries,
  and record profile links. Additionally, a low-severity security vulnerability was
  identified and fixed, with disclosure planned for a later date.
layout: post
