...
* **[Resources/Records]** On `resource` resources, a new `content` field allows the file content to be set by automations and the API. Previously, it was only possible for workers to upload a resource file in the browser.
