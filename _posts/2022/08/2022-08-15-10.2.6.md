---
title: 10.2.6
excerpt: Cerb 10.2.6 is a maintenance update released in August 2022 with 14 improvements
  from community feedback.
summary: This page details the release notes for Cerb version 10.2.6, a maintenance
  update launched on August 15, 2022. The update introduces 14 minor features and
  fixes based on community feedback from the 10.2 update. Key additions include new
  functions for DNS resolution in automation scripting, options to disable event triggers
  during record creation and updates, and enhancements in worklist exports and calendar
  data queries. Changes also improve the automation editor's user experience and expand
  LDAP configuration options. Fixes address issues with connected services and automation
  validation. The update aims to refine automation capabilities and improve user interaction
  with Cerb.
layout: post
