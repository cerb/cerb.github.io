---
title: 9.4.11
excerpt: Cerb 9.4.11 is a maintenance update released in February 2020 with 22 minor
  features and fixes from community feedback.
summary: This page details the release notes for Cerb version 9.4.11, a maintenance
  update released on February 12, 2020. It includes 22 minor features and fixes based
  on community feedback from the 9.4 update. Key updates include new filters for mailbox
  worklists, improvements in bot behaviors and scripting, enhancements in data queries
  and record search functionalities, and various user experience improvements. The
  update also addresses compatibility issues with PHP 7.4, which will be resolved
  in the upcoming Cerb 9.5 release. Additionally, it fixes issues related to snippets,
  ticket records, and bulk updates, among others, enhancing the overall functionality
