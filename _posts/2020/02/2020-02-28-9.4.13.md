---
title: 9.4.13
excerpt: Cerb 9.4.13 is a maintenance update released in February 2020 with 10 minor
  features and fixes from community feedback.
summary: This page details the release notes for Cerb version 9.4.13, a maintenance
  update launched on February 28, 2020. The update includes ten minor features and
  fixes based on community feedback from the 9.4 update. Key improvements include
  enhanced security through hardened endpoints, a fix for updating custom fields in
  the Support Center, a new page for exporting bots, and improved handling of images
  in mail signatures. Additionally, the update optimizes performance in various areas
  such as profile widget loading and ticket export processes, introduces a shortcut
  for editing project boards, and ensures a new session cookie is generated upon successful
  login.
layout: post
