...
excerpt: Cerb 10.0 is a generational major feature update in development during December 2020 with 95 improvements from community feedback.
...
[**Interactions**](/docs/automations/triggers/ui.interaction/) are interactive automations that use continuations to pause and resume a multi-step workflow.
