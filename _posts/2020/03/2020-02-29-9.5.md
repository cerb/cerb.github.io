---
title: "9.5"
excerpt: Cerb 9.5 is a privacy and security update released in March 2020 with 37
  improvements from community feedback.
summary: This page details the release of Cerb 9.5, a significant security update
  launched on March 3, 2020. The update introduces over 37 new features and improvements,
  focusing heavily on security enhancements and privacy measures. Key updates include
  email privacy and security features such as blocking external images from untrusted
  senders, anti-phishing protection, and PGP encryption enhancements. The release
  also addresses security hardening with a comprehensive audit of endpoints to prevent
  unauthorized access and improve CSRF and XSS protections. Additionally, the update
  includes improvements in record management, portal usability, and platform compatibility,
  notably with PHP 7.4 support. Cerb 9.5 is offered as a free update to all active
  and expired self-hosted licenses, emphasizing the ethical stance of not withholding
  security updates to encourage renewals.
layout: post
