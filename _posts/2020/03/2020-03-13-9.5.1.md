---
title: 9.5.1
excerpt: Cerb 9.5.1 is a maintenance update released in March 2020 with 20 minor features
  and fixes from community feedback.
summary: This page details the Cerb 9.5.1 maintenance update released on March 13,
  2020, which includes 20 minor features and fixes based on community feedback from
  the 9.5 update. Key improvements address issues across various components such as
  the knowledgebase API, bot behaviors, mail composition, and security. Notable fixes
  include resolving URL rewriting in knowledgebase articles, enhancing bot behavior
  node reordering, improving snippet insertion in mail composition, and preventing
  unsupported browsers from accessing the login form. The update also enhances data
  query handling, refines mail HTML link security, and improves user experience with
  popups and worklists. Additionally, it introduces new security settings for worker
  accounts and reorganizes security-related settings in the setup menu.
layout: post
