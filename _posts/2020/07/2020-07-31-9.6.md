---
layout: post
title:  "In Development: 9.6"
excerpt: Cerb 9.6 is a major feature update in development during July 2020 with 62 improvements from community feedback.
...
<img src="{{page.social_image_url}}" class="screenshot" alt="9.6">
</div>

**Cerb (9.6)** is a **{{ page.release.type }}** in development as of {{page.date|date:'%B %d, %Y'}}.  It includes more than **{{ page.release.count }}** new features and improvements from community feedback.
...
* Sticky notes and comments are condensed and longer show full headers, providing more differentiation with email messages.
...
Thanks to [@agilebits](https://github.com/agilebits/) for the feature request.
...
When composing and replying to mail, 'Before message sent' bot behaviors can now set ticket and message custom fields on the eventually created records (i.e. when mail is delivered successfully). [[#1308](https://github.com/jstanden/cerb/issues/1308)] [[#1308](https://github.com/jstanden/cerb/issues/1308)]
