---
title: 9.4.8
excerpt: Cerb 9.4.8 is a maintenance update released in January 2020 with 7 minor
  features and fixes from community feedback.
summary: This page details the release notes for Cerb version 9.4.8, a maintenance
  update issued on January 17, 2020. It highlights seven minor features and fixes
  based on community feedback from the 9.4 update. Key improvements include enhancements
  to the user experience when composing, replying, or commenting with inline images,
  validation of the 'From:' field in mail composition, and adjustments to bot behaviors
  affecting message scheduling. Additionally, new scripting functions and form interaction
  capabilities have been introduced, along with improved data query options for grouping
  dates by hour. These updates aim to streamline workflows and enhance functionality
