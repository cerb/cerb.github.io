---
title: 9.4.10
excerpt: Cerb 9.4.10 is a maintenance update released in January 2020 with 5 minor
  features and fixes from community feedback.
summary: This page details the Cerb 9.4.10 maintenance update released on January
  31, 2020. It highlights five minor features and fixes based on community feedback
  from the 9.4 update. Key improvements include resolving issues with file attachments
  in record comments, enhancing search capabilities for record links and attachments,
  fixing a placeholder tester issue on card widgets, and addressing PHP 7.4 compatibility
  notices and warnings, although bot scripting will remain incompatible until the
  next version, Cerb 9.5.
layout: post
