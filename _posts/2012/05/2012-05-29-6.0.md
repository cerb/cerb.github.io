---
title: "6.0"
excerpt: Cerb 6.0 is a major feature update released in May 2012 with 239+ new features
  and improvements from community feedback.
summary: This page provides a comprehensive overview of the Cerb 6.0 release, detailing
  its significant feature upgrades and improvements based on community feedback. Released
  on May 29, 2012, this version introduces over 239 new features, including enhancements
  to aesthetics, workspaces, virtual attendants, calendars, profiles, quick search,
  and mail functionalities. Key updates include a redesigned navigation system with
  customizable pages, improved virtual attendant capabilities with worklist variables
  and behavior simulators, and a new import service for bulk data handling. The release
  also focuses on performance improvements, plugin development enhancements, and maintenance
  updates addressing minor fixes and usability enhancements. Additionally, the page
  outlines the requirements for upgrading to this version and provides detailed release
  notes for each maintenance update from 6.0.1 to 6.0.6, highlighting specific fixes
  and enhancements made in response to user feedback.
layout: post
