---
title: 7.2.2
excerpt: Cerb 7.2.2 is a maintenance update released in August 2016 with 18 fixes
  and minor features from community feedback.
summary: This page details the release notes for Cerb version 7.2.2, a maintenance
  update launched on August 26, 2016. The update includes 18 features, fixes, and
  usability enhancements based on community feedback from the 7.2 update. Key improvements
  include resolving issues with community portal cache refreshing, attachment viewing
  permissions, and filtering linked buckets in profiles. Compatibility with PHP7 has
  been enhanced, and several fixes have been made to Virtual Attendants, worklists,
  and the REST API. New quick search filters for ticket worklists and improvements
  in the usability of Virtual Attendant behavior editing are also highlighted. Additionally,
  enhancements in exporting worklists and handling attachments in the API are included.
layout: post
