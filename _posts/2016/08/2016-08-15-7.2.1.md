---
title: 7.2.1
excerpt: Cerb 7.2.1 is a maintenance update released in August 2016 with 12 fixes
  and minor features from community feedback.
summary: This page details the Cerb 7.2.1 maintenance update released on August 15,
  2016, which includes 12 features, fixes, and usability enhancements based on community
  feedback from the 7.2 update. Key improvements include fixing card popup issues,
  implementing card popups for opportunity records, adding quick search functionality
  in the Setup->Workers worklist, and introducing a 'Save Changes' button in card
  configuration to address user confusion with auto-save. The update also enhances
  bulk update capabilities, allowing for the deletion of multiple organization and
  contact records, and improves usability by simplifying task and ticket worklist
  updates with checkbox selections. Additionally, it resolves issues with group and
  bucket card ticket count filters.
layout: post
