---
title: 7.1.4
excerpt: Cerb 7.1.4 is a maintenance update released in February 2016 with 12 fixes
  and minor features from community feedback.
summary: This page details the release notes for Cerb version 7.1.4, a maintenance
  update issued on February 15, 2016. The update includes 12 improvements based on
  community feedback from the 7.1 update. Key fixes and enhancements include resolving
  issues with account registration in the Support Center, correcting multibyte character
  corruption in various functionalities, updating the logo displayed on 404 error
  pages, and improving Virtual Attendant behaviors with numeric parameters and custom
  fields. Additional updates address defects in adding multiple watchers to records,
  PHP7 compatibility tweaks, installer issues, and enhancements in the Support Center
  such as an 'Edit' button for ticket modifications and improved activity logging.
  Security improvements were also made to directory permissions during installation.
layout: post
