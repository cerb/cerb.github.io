---
title: 7.1.5
excerpt: Cerb 7.1.5 is a maintenance update released in March 2016 with 6 fixes and
  minor features from community feedback.
summary: This page details the Cerb 7.1.5 maintenance update released on March 7,
  2016, which includes six features, fixes, and usability enhancements based on community
  feedback from the 7.1 update. Key improvements include the addition of a 'Cc:' field
  in Support Center contact forms, a fix for multiple form submissions using the same
  CAPTCHA, and several ticket-related enhancements such as preserving the 'reopen
  at' date when closing tickets and resolving issues with sticky notes on ticket profiles.
  The update also addresses a problem with sticky notes interfering with the reply
  form in emails.
layout: post
