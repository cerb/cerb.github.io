---
title: 7.1.6
excerpt: Cerb 7.1.6 is a maintenance update released in June 2016 with 13 fixes and
  minor features from community feedback.
summary: This page details the Cerb 7.1.6 maintenance update released on June 9, 2016,
  which includes 13 features, fixes, and usability enhancements based on community
  feedback from the 7.1 update. Key improvements involve resolving issues with Virtual
  Attendants, such as fixing errors in 'Create task' and 'Create ticket' actions,
  enhancing the 'Set (date) variable' action, and improving email sending and recipient
  handling. The update also addresses problems with ticket worklist exports, message-based
  worklists, and Support Center contact forms, ensuring required fields are enforced
  and improving user interaction with subject fields. Additionally, it corrects a
  bug on the '/debug/report' page and ensures Virtual Attendant behaviors handle invalid
