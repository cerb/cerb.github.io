---
title: "6.7"
excerpt: Cerb 6.7 is a major feature update released in April 2014 with 106+ new features
  and improvements from community feedback.
summary: This page details the release notes for Cerb version 6.7, a feature upgrade
  launched on April 22, 2014. The update includes over 106 new features and improvements
  based on community feedback. Key enhancements cover areas such as workspaces, worklist
  exports, virtual attendants, search capabilities, security, support center customization,
  caching, and overall performance improvements. The release also introduces new plugins
  for search and cache engines, supports Sphinx Search, and enhances usability and
  plugin development. Additionally, the page provides instructions for upgrading,
  highlights important release notes, and lists maintenance updates from 6.7.1 to
  6.7.9, each addressing minor features, fixes, and usability enhancements. The release
  emphasizes improved efficiency, security, and user experience across various functionalities
  of the Cerb platform.
layout: post
