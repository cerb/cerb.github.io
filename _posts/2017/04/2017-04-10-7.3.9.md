---
title: 7.3.9
excerpt: Cerb 7.3.9 is a maintenance update released in April 2017 with 15 fixes and
  minor features from community feedback.
summary: This page details the release notes for Cerb version 7.3.9, a maintenance
  update released on April 10, 2017. The update includes 15 fixes and minor features
  based on community feedback from the 7.3 update. Key improvements include security
  fixes related to the Twig sandbox, enhancements in mail search with new deep search
  filters for ticket worklists, and expanded API capabilities. The API updates allow
  for more detailed worker management, including setting authentication methods, personal
  details, and contact information. Additionally, the API now supports creating and
  updating groups, as well as managing group members and managers.
layout: post
