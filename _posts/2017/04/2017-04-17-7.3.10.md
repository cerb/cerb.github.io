---
title: 7.3.10
excerpt: Cerb 7.3.10 is a maintenance update released in April 2017 with 11 fixes
  and minor features from community feedback.
summary: This page details the release notes for Cerb version 7.3.10, a maintenance
  update released on April 17, 2017. The update includes 11 fixes and minor features
  based on community feedback from the 7.3 update. Key improvements include enhancements
  to the API for activity log entries, fixes for bot behaviors related to ticket ownership
  and conversational exits, performance improvements for handling long comments, and
  permissions adjustments for creating snippets. Additionally, issues with exporting
  attachment worklists, subtotaling custom fields, and bot scripting with XML have
  been addressed. The update also resolves a display issue on the snippets profile
  page.
layout: post
