---
title: 7.3.2
excerpt: Cerb 7.3.2 is a maintenance update released in February 2017 with 11 fixes
  and minor features from community feedback.
summary: This page details the Cerb 7.3.2 maintenance update released on February
  20, 2017, which includes 11 fixes and minor features based on community feedback
  from the 7.3 update. Key improvements include resolving issues with activity log
  actor misattribution, HTML mail template image embedding, and usability enhancements
  for activity log and notification worklists. The update also introduces better functionality
  for cards, such as opening profiles in new tabs, displaying and marking notifications
  as read, and adding sticky notes and comments to message cards. Additionally, it
  addresses issues with editing and deleting comments and sticky notes on records
  and tickets.
layout: post
