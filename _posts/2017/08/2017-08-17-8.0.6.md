---
title: 8.0.6
excerpt: Cerb 8.0.6 is a maintenance update released in August 2017 with 10 minor
  features and fixes from community feedback.
summary: This page details the Cerb 8.0.6 maintenance update released on August 17,
  2017, which includes 10 fixes and minor features based on community feedback from
  the 8.0 update. Key improvements include fixes in bot behavior imports, enhancements
  in mail filtering with new placeholders, improved API responses for file attachments,
  usability enhancements in the profile picture editor, and better simulation feedback
  for HTTP requests in bot behaviors. Additionally, it addresses compatibility issues
  with conversational bots in Internet Explorer 11. The update aims to streamline
  user experience and improve functionality across various features.
layout: post
