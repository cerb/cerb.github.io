...
**Cerb (8.1)** is a **{{ page.release.type }}** released on August 29, 2017.  It contains more than **{{ page.release.count }}** new features and improvements from community feedback.
