---
title: 7.3.12
excerpt: Cerb 7.3.12 is a maintenance update released in May 2017 with 16 fixes and
  minor features from community feedback.
summary: This page details the release notes for Cerb version 7.3.12, a maintenance
  update issued on May 24, 2017. The update addresses 16 fixes and minor enhancements
  based on community feedback from the 7.3 update. Key improvements include resolving
  issues with worklists, such as blank custom field subtotals and quick search discrepancies,
  enhancing report filtering capabilities, optimizing ticket history performance,
  and fixing dashboard chart and gauge functionalities. Additionally, the update refines
  bot event handling, API activity log sorting, and mail composition features, while
  also addressing issues in the Support Center portal. These changes aim to improve
  the overall efficiency and user experience of the Cerb platform.
layout: post
