...
date:   2017-01-13 12:40:00 -0700
permalink: /releases/7.3/
redirect_from: /7.3/
redirect_from: /wiki/7.3/
...
**Cerb (7.3)** is a **{{ page.release.type }}** in **beta** as of January 9, 2017.  It currently contains over **{{ page.release.count }}** new features and improvements from community feedback.  <!-- There are 59 additional improvements provided in 4 maintenance updates. -->
...
See: [Connected Accounts](/docs/connected-accounts)
...
See: [Classifiers](/docs/classifiers)
...
On ticket worklists, the 'First Wrote' and 'Last Wrote' columns now display the contact's name (if known) as well as their email address.
