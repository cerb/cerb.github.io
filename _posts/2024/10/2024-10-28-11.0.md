---
layout: post
title:  "In Development: 11.0"
excerpt: Cerb 11.0 is a platform upgrade in development as of October 2024 with 146 improvements from community feedback.
...
**Cerb (11.0)** is a **{{ page.release.type }}** in development as of {{page.date|date:'%B %d, %Y'}}.  It includes more than **{{ page.release.count }}** new features and improvements from community feedback.
...
* **[Workflows/Library]** Added a `cerb.surveys.csat` workflow for gathering and monitoring customer satisfaction metrics like NPS, CSAT, and CES.
...
* **[Classifiers/Plugins]** Moved the [Classifiers](/docs/classifiers/) functionality to an optional plugin. When this is needed, it simplifies UX by removing four record types (classifiers, classifications, classifier entity, and classifier example).
