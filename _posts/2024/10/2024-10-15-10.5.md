---
layout: post
title:  "In Development: 10.5"
excerpt: Cerb 10.5 is a major feature update in development as of October 2024 with 107 improvements from community feedback.
author: The Cerb Team
date: 2024-10-08 12:30:00 -0700
permalink: /releases/10.5/
social_image_url: /assets/images/releases/10.5/10.5.png
redirect_from:
  - /10.5/
...
**Cerb (10.5)** is a **{{ page.release.type }}** in development as of {{page.date|date:'%B %d, %Y'}}.  It includes more than **{{ page.release.count }}** new features and improvements from community feedback.
...
<div class="cerb-box note">
	<p>
		To check if you qualify for this release as a free update, view <b>Setup &raquo; Configure &raquo; License</b>. If your software updates expire on or after <b>December 31, 2023</b> then you can upgrade without renewing your license.  Cerb Cloud subscribers will be upgraded automatically.
	</p>
</div>
...
* **Cerb 10.5** requires **PHP 8.2+** and **MySQL 8.0+** (or **MariaDB 10.5+**).

* To upgrade your installation, [follow these instructions](/docs/upgrading/).

* **NOTE:** The [branches](https://github.com/cerb/cerb-release/branches) in the `cerb/cerb-release` repository have changed. The `master` branch has been removed, and new branches exist for each major version (e.g. `v10.4`, `v10.5`).
