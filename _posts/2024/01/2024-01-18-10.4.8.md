---
title: 10.4.8
excerpt: Cerb 10.4.8 is a maintenance update released in January 2024 with 7 improvements
  from community feedback.
summary: This page details the release notes for Cerb version 10.4.8, a maintenance
  update released on January 18, 2024. The update includes seven minor features and
  fixes based on community feedback from the 10.4 update. Key additions include the
  ability for fileDownload form elements in interaction.worker automations to reference
  resource records. Changes involve adjustments to database query retries to prevent
  unexpected duplicates and enhancements to ticket profiles with badges indicating
  banned or defunct message senders. Fixes address issues such as database read timeouts,
  duplicate message drafts due to network latency, and double binding of date helper
  fields. A security update improves the visibility of the 'Add to participants' button
  in ticket conversations to prevent unauthorized access.
layout: post
