---
title: 10.4.10
excerpt: Cerb 10.4.10 is a maintenance update released in April 2024 with 23 improvements
  from community feedback.
summary: This page details the release notes for Cerb version 10.4.10, a maintenance
  update released on April 8, 2024. The update includes 23 minor features and fixes
  based on community feedback from the 10.4 update. Key changes include enhancements
  to automation commands, toolbar autocompletion, worklist logging, and sheet link
  usability. The update also addresses several fixes, such as PHP 8.2+ deprecation
  warnings, password change issues in the Support Center, and activity log inaccuracies.
  Security improvements are a significant focus, with updates to dependencies, password
  policies, account registration and recovery processes, and CAPTCHA challenges to
  enhance security and prevent abuse.
layout: post
author: The Cerb Team
date: "2024-04-08 08:00:00 -0800"
permalink: /releases/10.4.10/
social_image_url: /assets/images/releases/10.4/10.4.10.png
redirect_from:
- /10.4.10/
...
**Cerb (10.4.10)** is a **{{ page.release.type }}** released on {{page.date|date:'%B %d, %Y'}}. It includes **{{ page.release.count}}** minor features and fixes from community feedback covering the [10.4](/releases/10.4/) update.  You can [follow these instructions](/docs/upgrading/) to upgrade.
...
* **[Sheets/Links/UX]** In sheets, `link:` column icons are now also clickable. This allows a column with only icons. Previously, only the label text was clickable. Thanks to [@mryanb](https://github.com/mryanb/) for the feature request.
