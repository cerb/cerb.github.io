---
title: 10.3.5
excerpt: Cerb 10.3.5 is a maintenance update released in January 2023 with 8 improvements
  from community feedback.
summary: This page details the Cerb 10.3.5 maintenance update released on January
  13, 2023, which includes eight minor features and fixes based on community feedback
  from the 10.3 update. Key changes involve improvements in the automation editor
  and event editor with enhanced validation to prevent errors, performance enhancements
  in the maintenance scheduler, and updates to the full-text search indexer. Additionally,
  the update addresses issues such as email parsing errors, legacy group behavior
  in automations, and user experience glitches in worker interactions. The page also
  provides instructions for upgrading to this version.
layout: post
