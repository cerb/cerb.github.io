---
title: 10.3.6
excerpt: Cerb 10.3.6 is a maintenance update released in January 2023 with 10 improvements
  from community feedback.
summary: This page details the Cerb 10.3.6 maintenance update released on January
  27, 2023, which includes 10 minor features and fixes based on community feedback
  from the 10.3 update. Key additions include enhancements to resource records, automation-backed
  webhooks, and file writing in automations, as well as improvements in data query
  capabilities for metrics. Changes include suppressing PHP 8.2 deprecation warnings
  in production. Fixes address issues with legacy group-owned behaviors, POP3 mailbox
  timeout settings, navigation menu functionality in some browsers, and data query
  aggregation in metrics. The page also provides instructions for upgrading to this
  version.
layout: post
