---
title: 10.3.10
excerpt: Cerb 10.3.10 is a maintenance update released in June 2023 with 13 improvements
  from community feedback.
summary: This page details the release notes for Cerb version 10.3.10, a maintenance
  update released on June 17, 2023. The update includes 13 minor features and fixes
  based on community feedback from the 10.3 update. Key additions include an example
  for `xml_decode` in automation scripting. Changes involve improvements in data queries
  for custom fields and enhancements in the installer user experience. Several fixes
  address issues with card sheet widgets, session cookies, browser compatibility (particularly
  with Safari), email parsing, mail routing, and caching with Redis. The update aims
  to enhance functionality, user experience, and system stability.
layout: post
