---
title: 10.3.8
excerpt: Cerb 10.3.8 is a maintenance update released in April 2023 with 15 improvements
  from community feedback.
summary: This page details the release notes for Cerb version 10.3.8, a maintenance
  update launched on April 21, 2023. It highlights 15 minor features and fixes based
  on community feedback from the 10.3 update. Key additions include a new stats service
  for the platform, enhancements in automation scripting, and improvements in time
  tracking usability. Changes involve making snippet prompts optional, while fixes
  address inefficiencies in worklists, spam score filtering, and UI issues in time
  tracking. Security updates include upgrading the Smarty template engine and the
  Guzzle library in response to advisories. The page also provides instructions for
