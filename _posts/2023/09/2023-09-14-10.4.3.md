---
title: 10.4.3
excerpt: Cerb 10.4.3 is a maintenance update released in September 2023 with 15 improvements
  from community feedback.
summary: This page details the Cerb 10.4.3 maintenance update released on September
  14, 2023, which includes 15 minor features and fixes based on community feedback
  from the 10.4 update. Key additions include a new record.merged automation event
  and improvements in resource handling and caching. Changes enhance automation resource
  suggestions, sheet icon definitions, and interaction elements. Fixes address issues
  with automation commands, recurring timers, mail composition, activity log triggers,
  resource record creation, and toolbar functionality. The update aims to refine user
