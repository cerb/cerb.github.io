---
title: 9.3.6
excerpt: Cerb 9.3.6 is a maintenance update released in October 2019 with 9 minor
  features and fixes from community feedback.
summary: This page details the Cerb 9.3.6 maintenance update released on October 20,
  2019, which includes nine minor features and fixes based on community feedback from
  the 9.3 update. Key improvements include the implementation of autocompletion for
  calendar and classifier name filters in search/data queries, fixes for issues related
  to custom fields and database query read/write splitting, and enhancements in bot
  behaviors to prevent errors. Additionally, user experience improvements were made
  to card editor popups, and new filtering and subtotaling options were added to workspace
  page worklists. The update also ensures consistent toolbar order on behavior cards.
layout: post
