---
title: 9.3.4
excerpt: Cerb 9.3.4 is a maintenance update released in September 2019 with 10 minor
  features and fixes from community feedback.
summary: This page details the release notes for Cerb version 9.3.4, a maintenance
  update launched on September 22, 2019. The update addresses 10 minor features and
  fixes based on community feedback from the 9.3 update. Key improvements include
  resolving issues with search popup titles containing special characters, fixing
  installer requirements for MySQL 5.7, enhancing form interaction widgets, and improving
  comment display on profiles. Additionally, the update introduces permalinks for
  comments across all record types, allows basic HTML formatting in sheet widgets,
  and corrects API subtotal functionality. Other enhancements include displaying worker
  titles in comments and adding the 'Owner' field in custom record profiles.
layout: post
