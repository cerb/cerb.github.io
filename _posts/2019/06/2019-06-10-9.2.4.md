---
title: 9.2.4
excerpt: Cerb 9.2.4 is a maintenance update released in June 2019 with 9 minor features
  and fixes from community feedback.
summary: This page details the Cerb 9.2.4 maintenance update released on June 10,
  2019, which includes nine minor features and fixes based on community feedback from
  the 9.2 update. Key improvements focus on performance enhancements for loading large
  numbers of records and record dictionaries, optimizing API search endpoints, and
  refining key expansion processes. Additional updates include a new filter for profile
  widget worklists, a command-line tool for package imports, and improvements to the
  auto-hyperlinking filter in plaintext emails and comments to enhance readability
  and prevent errors.
layout: post
