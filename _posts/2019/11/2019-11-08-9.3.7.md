---
title: 9.3.7
excerpt: Cerb 9.3.7 is a maintenance update released in November 2019 with 21 minor
  features and fixes from community feedback.
summary: This page details the release notes for Cerb version 9.3.7, a maintenance
  update released on November 8, 2019. The update includes 21 minor features and fixes
  based on community feedback from the 9.3 update. Key improvements include fixes
  for OAuth2 service providers, email parser issues with long subject lines, and updates
  to the Google connected service in the package library. The update also addresses
  issues with dashboard widgets, record fields, and custom records, enhancing performance
  and user experience. Additionally, it includes security updates, UI improvements,
  and enhancements to bot behaviors and worker search functionalities. The page provides
