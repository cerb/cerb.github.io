---
title: 9.4.5
excerpt: Cerb 9.4.5 is a maintenance update released in December 2019 with 11 minor
  features and fixes from community feedback.
summary: This page details the release notes for Cerb version 9.4.5, a maintenance
  update launched on December 31, 2019. It highlights 11 minor features and fixes
  based on community feedback from the 9.4 update. Key improvements include enhanced
  user experience in mail composition with a new `#snippet` command for inserting
  frequently used snippets, improved `@mention` autocompletion performance, and new
  filters for ticket worklists. The update also addresses issues with bot logging,
  inline image uploads, and introduces keyboard shortcuts for common actions in mail
  and comments. Additionally, it improves the file chooser interface and streamlines
  the process of inserting links and managing autocomplete suggestions.
layout: post
