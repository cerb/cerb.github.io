---
title: 9.3.9
excerpt: Cerb 9.3.9 is a maintenance update released in December 2019 with 4 minor
  features and fixes from community feedback.
summary: This page details the release of Cerb version 9.3.9, a maintenance update
  from December 10, 2019. It highlights four minor features and fixes based on community
  feedback from the 9.3 update. Key improvements include enhancements to custom record
  profile widgets with new fields, a fix for 'Custom' profile widgets to ensure widget
  placeholders are available in bot behavior, adjustments to activity log worklists
  for clearer event descriptions, and the introduction of a `params` key in activity
  log dictionaries for custom metadata handling.
layout: post
