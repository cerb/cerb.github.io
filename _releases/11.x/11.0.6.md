---
title: "11.0.6"
excerpt: Cerb 11.0.6 is a maintenance update released in March 2025 with 19 improvements from community feedback.
...
**Cerb (11.0.6)** is a **{{ page.release.type }}** released on {{page.date|date:'%B %d, %Y'}}. It includes **{{ page.release.count}}** minor features and fixes from community feedback covering the [11.0](/releases/11.0/) update.  You can [follow these instructions](/docs/upgrading/) to upgrade.
