---
title: "11.1.7"
excerpt: Cerb 11.1.7 is a maintenance update released in March 2026 with 14 improvements from community feedback.
...
permalink: /releases/11.1.7/
social_image_url: /assets/images/releases/11.1/11.1.7.png
release:
...
**Cerb (11.1.7)** is a **{{ page.release.type }}** released on {{page.date|date:'%B %d, %Y'}}. It includes **{{ page.release.count}}** minor features and fixes from community feedback covering the [11.1](/releases/11.1/) update.  You can [follow these instructions](/docs/upgrading/) to upgrade.
