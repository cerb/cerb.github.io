...
jumbotron:
  title: "6.4"
excerpt: Cerb 6.4 is a major feature update released in June 2013 with 118+ new features
  and improvements from community feedback.
summary: This page details the release of Cerb version 6.4, a feature upgrade launched
  on June 7, 2013, which introduces over 118 new features and improvements based on
  community feedback. Key enhancements include the introduction of custom fieldsets,
  allowing for more organized and specific data classification, and significant improvements
  to calendar functionalities, such as recurring events, calendar datasources, and
  integration with Virtual Attendants. The update also enhances dashboards with new
  widgets and improved usability, allows for the import and export of workspace configurations,
  and introduces new capabilities for Virtual Attendants, including behavior import/export
  and worklist modifications. Additionally, the release includes updates to mail handling,
  such as improved POP3 mailbox management and new keyboard shortcuts for replying
  to tickets. The update also addresses plugin development and maintenance, providing
  tools for easier plugin updates and development. Maintenance updates 6.4.1 to 6.4.4
  follow, addressing minor fixes and usability enhancements. The page emphasizes the
  importance of backing up before upgrading and provides instructions for checking
  eligibility for a free update.
