...
jumbotron:
  title: "6.2"
excerpt: Cerb 6.2 is a major feature update released in December 2012 with 123+ new
  features and improvements from community feedback.
summary: This page details the release of Cerb version 6.2, a significant feature
  upgrade launched on December 17, 2012, incorporating over 123 new features and improvements
  based on community feedback. Key enhancements include advanced dashboard functionalities
  with new chart types, counters, and custom HTML widgets, as well as improved worklists
  and virtual attendants with enhanced activity logs, custom fields, and mail filtering
  capabilities. Security updates feature improved authentication methods, account
  recovery processes, and the introduction of Google Authenticator for two-factor
  authentication. The mail system sees usability improvements in composing, drafting,
  and replying to messages. The update also introduces new capabilities for community
  portals, calendars, opportunities, and the Web-API, alongside performance optimizations
  and platform enhancements for plugin development. Maintenance updates from 6.2.1
  to 6.2.5 address minor fixes and usability enhancements, ensuring a more robust
