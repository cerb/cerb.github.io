...
jumbotron:
  title: 7.3.13
excerpt: Cerb 7.3.13 is a maintenance update released in June 2017 with 7 fixes and
  minor features from community feedback.
summary: This page details the release of Cerb version 7.3.13, a maintenance update
  from June 7, 2017, which addresses seven fixes and minor features based on community
  feedback from the 7.3 update. Key improvements include resolving issues with group
  and bot profiles, enhancing worklist subtotaling by 'Owner', and refining snippet
  worklists with a new filter. Additionally, it fixes a problem with custom fields
  in the REST API and improves bot interactions with worklists and scripting by introducing
  a new filter for decoding HTML encoding. The update aims to streamline user experience
  and improve functionality across various components of Cerb.
