...
jumbotron:
  title: "7.2"
excerpt: Cerb 7.2 is a major feature update released in August 2017 with 143+ new
  features and improvements from community feedback.
summary: This page details the release of Cerb 7.2, a significant feature upgrade
  launched on August 5, 2016, which includes over 143 new features and improvements
  based on community feedback, along with 85 additional enhancements from subsequent
  maintenance updates. The release focuses on scalability and performance improvements,
  particularly for cloud-based deployments, enabling Cerb to handle hundreds of concurrent
  workers and tens of thousands of messages daily. Key enhancements include improved
  quick search capabilities, more flexible worklist filters, and better usability
  of Virtual Attendant behaviors. The update also introduces customizable fields on
  card popups, faster dashboard widget loading, and improved bulk update processes.
  Additionally, the release enhances search performance and relevance, optimizes email
  handling, and improves task management with new owner and importance fields. The
  platform's scalability, security, and monitoring capabilities are also significantly
  enhanced, making it more efficient and resilient in distributed environments. The
  update is available as a free upgrade for users with licenses expiring on or after
  May 1, 2016.
