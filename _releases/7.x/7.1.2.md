...
jumbotron:
  title: 7.1.2
excerpt: Cerb 7.1.2 is a maintenance update released in January 2016 with 28 fixes
  and minor features from community feedback.
summary: This page details the release notes for Cerb version 7.1.2, a maintenance
  update launched on January 05, 2016, which includes 28 improvements based on community
  feedback from the 7.1 update. Key enhancements include improved usability in ticket
  profiles, Virtual Attendants, and choosers, as well as fixes for issues related
  to mail transport deletion, watcher removal, and profile picture caching. The update
  also introduces new functionalities such as drag-and-drop file attachments in mail
  forms, customizable profile picture options, and enhanced Virtual Attendant actions
  for creating and managing server, domain, call, and asset records. These improvements
  aim to streamline user experience and expand automation capabilities within the
  Cerb platform.
