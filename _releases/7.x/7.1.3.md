...
jumbotron:
  title: 7.1.3
excerpt: Cerb 7.1.3 is a maintenance update released in January 2016 with 16 fixes
  and minor features from community feedback.
summary: This page details the release notes for Cerb version 7.1.3, a maintenance
  update launched on January 25, 2016. It includes 16 improvements based on community
  feedback from the 7.1 update. Key enhancements involve better handling of HTML messages
  in Microsoft environments, improved usability in viewing timelines and comments,
  and fixes for mail routing and API requests. The update also addresses issues with
  Virtual Attendants, organization profiles, mail composition, and worklists. Additionally,
  it resolves various usability issues across profiles, including tab navigation and
  search functionalities, ensuring a more streamlined user experience.
