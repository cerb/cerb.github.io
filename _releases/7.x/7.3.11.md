...
jumbotron:
  title: 7.3.11
excerpt: Cerb 7.3.11 is a maintenance update released in May 2017 with 18 fixes and
  minor features from community feedback.
summary: This page details the release notes for Cerb version 7.3.11, a maintenance
  update released on May 4, 2017. The update includes 18 fixes and minor features
  based on community feedback from the 7.3 update. Key improvements include fixes
  in bot scripting, webhooks, and event handling, as well as optimizations in bot
  behaviors, localization, and performance. New scripting functions and filters have
  been added, such as `random_string`, `validate_email`, and `hash_hmac`, enhancing
  bot and snippet scripting capabilities. Additionally, issues with worklists, dashboards,
  and custom fields have been addressed to improve functionality and accuracy in data
