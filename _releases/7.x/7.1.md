...
jumbotron:
  title: "7.1"
excerpt: Cerb 7.1 is a major feature update released in December 2015 with 111+ new
  features and improvements from community feedback.
summary: This page details the beta release of Cerb 7.1, a feature upgrade that introduces
  over 111 new features and improvements based on community feedback, with an additional
  99 enhancements from maintenance updates. The release focuses on personalization
  and machine learning, with significant advancements in contact management, setting
  the stage for future community-building enhancements. Key features include improved
  card popups for records, enhanced contact records independent of communication medium,
  built-in profile picture management, and improved search functionalities. The update
  also enhances workspaces, dashboards, virtual attendants, calendars, choosers, mail
  handling, and support center aesthetics. It addresses platform security, MySQL strict
  mode compatibility, and usability improvements, while also providing new tools and
  plugins for developers. The release emphasizes Cerb's commitment to empowering teams
  with robust enterprise productivity and workflow automation tools.
