...
jumbotron:
  title: 7.1.1
excerpt: Cerb 7.1.1 is a maintenance update released in December 2015 with 37 fixes
  and minor features from community feedback.
summary: This page details the release notes for Cerb version 7.1.1, a maintenance
  update launched on December 23, 2015. The update includes 37 improvements based
  on community feedback from the 7.1 update. Key enhancements involve fixing issues
  with ticket profiles, Virtual Attendant simulators, and worker choosers. The update
  also introduces new features such as improved avatar handling with Gravatar, enhanced
  bulk update functionalities, and new options for Virtual Attendants, including performance
  improvements and additional actions for creating tasks, tickets, and opportunities.
  The update aims to streamline user interactions, improve system efficiency, and
