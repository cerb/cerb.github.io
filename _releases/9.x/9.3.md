...
jumbotron:
  title: "9.3"
excerpt: Cerb 9.3 is a major feature update released in June 2019 with 69 improvements
  from community feedback.
summary: This page details the release of Cerb 9.3, a feature upgrade launched on
  June 11, 2019, which introduces over 69 new features and improvements based on community
  feedback. Key highlights include intelligent autocomplete suggestions for queries,
  enhanced data visualization through sheets, and dynamic form interactions. The update
  also enhances workspaces and dashboards with new tab styles and widgets, improves
  bot functionalities with record ID behavior variables, and refines data queries
  with better validation and subtotal capabilities. Additionally, the release includes
  updates to the API and platform, such as lazy cache invalidation by tag. The page
  provides important release notes, including system requirements and upgrade instructions,
  and emphasizes the need for a backup before upgrading.
