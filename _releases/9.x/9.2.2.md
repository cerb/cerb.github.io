...
jumbotron:
  title: 9.2.2
excerpt: Cerb 9.2.2 is a maintenance update released in March 2019 with 22 minor features
  and fixes from community feedback.
summary: This page details the Cerb 9.2.2 maintenance update released on March 29,
  2019, which includes 22 minor features and fixes based on community feedback from
  the 9.2 update. Key improvements include PHP 7.3 compatibility, enhancements to
  bot behavior and scripting, and fixes for bot simulator issues. The update also
  addresses ownership issues in packages for bots, saved searches, calendars, and
  classifiers. New features include a 'Bot Scripting Tester' and 'OAuth2 Token Generator'
  for developers, as well as improvements in API authentication and data query handling.
  Additionally, the update enhances user experience with better auto-hyperlinking
  in emails and resolves issues in mobile browsers and legacy printing plugins.
