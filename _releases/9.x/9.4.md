...
jumbotron:
  title: "9.4"
excerpt: Cerb 9.4 is a major feature update released in December 2019 with 98 improvements
  from community feedback.
summary: This page details the release of Cerb 9.4, a feature upgrade launched on
  December 10, 2019, which introduces over 98 new features and improvements based
  on community feedback. Key enhancements include customizable cards with various
  widgets, advanced custom fields, enriched comment functionalities with formatting
  and image support, and improved mail handling with options for scheduling messages
  and enhanced editors for composing, replying, and broadcasting. The update also
  brings advancements in dashboards, bots, form interactions, search capabilities,
  data queries, and record management. Security is bolstered with stronger password
  hashes, and performance is optimized through caching and indexing. The platform
  sees feature deprecations and retirements, alongside updates to dependencies and
  developer tools. The release notes emphasize the importance of backups before upgrading
  and specify system requirements for PHP and MySQL.
