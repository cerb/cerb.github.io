...
jumbotron:
  title: 9.1.8
excerpt: Cerb 9.1.8 is a maintenance update released in March 2019 with 14 minor features
  and fixes from community feedback.
summary: This page details the Cerb 9.1.8 maintenance update released on March 4,
  2019, which includes 14 minor features and fixes based on community feedback from
  the 9.1 update. Key improvements include fixes for worklists and knowledgebase article
  filters, enhancements in performance for saved searches, comments, and roles, and
  updates to bot scripting capabilities. The update also addresses issues with login
  recovery, data queries, file bundle editor popups, and notification worklists, ensuring
