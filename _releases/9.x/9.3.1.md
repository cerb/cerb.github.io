...
jumbotron:
  title: 9.3.1
excerpt: Cerb 9.3.1 is a maintenance update released in June 2019 with 11 minor features
  and fixes from community feedback.
summary: This page details the Cerb 9.3.1 maintenance update released on June 26,
  2019, which includes 11 minor features and fixes based on community feedback from
  the 9.3 update. Key improvements include enhancements to the user experience in
  sheet schema definitions with added autocomplete suggestions and documentation links,
  fixes for bot task creation events, and improvements in code editor functionality
  for search and data queries. Additionally, the update addresses issues with OAuth2
  API authentication, support center knowledgebase content display, and introduces
  the ability to subtotal message records by ticket bucket. These updates aim to refine
  the functionality and user experience of Cerb.
