...
jumbotron:
  title: 9.5.7
excerpt: Cerb 9.5.7 is a maintenance update released in June 2020 with 17 minor features
  and fixes from community feedback.
summary: This page details the Cerb 9.5.7 maintenance update released on June 17,
  2020, which includes 17 minor features and fixes based on community feedback. Key
  updates include improvements in mail encryption, support center password recovery,
  connected account search filters, and bot behaviors. Specific issues addressed involve
  PGP signing, account recovery processes, custom field handling, and bot scripting.
  Enhancements were made to user interface elements like cards and profiles, mail
  composition, and form interactions. The update also resolves issues with exporting
  custom fields, handling long email subjects, and allows for better integration of
  the compose popup in various functionalities.
