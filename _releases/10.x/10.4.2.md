...
jumbotron:
  title: 10.4.2
excerpt: Cerb 10.4.2 is a maintenance update released in September 2023 with 13 improvements
  from community feedback.
summary: This page details the Cerb 10.4.2 maintenance update released on September
  7, 2023, which includes 13 minor features and fixes based on community feedback
  from the 10.4 update. Key additions include a new toolbar for editing profile images
  with custom logic, integration of Stability.ai for image generation, and enhancements
  to record dictionaries and UI elements. Changes involve improvements to automation
  widgets and file handling, while fixes address issues with OpenID Connect SSO, file
  writing in automations, and role permissions. The update aims to enhance user experience
  and functionality through these targeted improvements.
