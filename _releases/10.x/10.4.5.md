...
jumbotron:
  title: 10.4.5
excerpt: Cerb 10.4.5 is a maintenance update released in November 2023 with 12 improvements
  from community feedback.
summary: This page details the release notes for Cerb version 10.4.5, a maintenance
  update launched on November 24, 2023. It highlights 12 minor features and fixes
  based on community feedback from the 10.4 update. Key additions include enhancements
  in mail filtering automations, expanded automation dictionaries, and improved record
  management for email addresses and contacts. Changes involve updates to automation
  commands and performance improvements in package imports. Fixes address issues in
  automation exports, explore mode for custom records, validation in automations,
  and API-related community portal creation. The page also provides instructions for
