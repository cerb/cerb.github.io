...
jumbotron:
  title: 10.3.1
excerpt: Cerb 10.3.1 is a maintenance update released in October 2022 with 28 improvements
  from community feedback.
summary: This page details the release notes for Cerb version 10.3.1, a maintenance
  update launched on October 18, 2022. The update includes 28 minor features and fixes
  based on community feedback from the 10.3 update. Key enhancements involve improvements
  to Chart KATA widgets, such as the ability to disable tooltips, hide legends, and
  configure tooltip displays. Additional features include caching for data queries,
  enhanced usability with spinners, and custom color patterns for charts. Changes
  also address error handling in datasets, font resource efficiency, and improved
  tooltip displays. Fixes cover PHP syntax issues, UI alignment, S3 storage engine
  compatibility, and dashboard visualization conflicts. Security updates include changes
  to PDF display settings and enhanced privacy for Twitter plugin user profile images.
