...
jumbotron:
  title: 10.4.11
excerpt: Cerb 10.4.11 is a maintenance update released in April 2024 with 16 improvements
  from community feedback.
summary: This page details the release notes for Cerb version 10.4.11, a maintenance
  update launched on April 12, 2024. It highlights 16 minor features and fixes based
  on community feedback from the 10.4 update. Key additions include configurable sort
  order for ticket merging, conditional row selection in sheets, and optimized ticket
  requester key expansion. Changes involve improved performance in activity logs,
  notifications, automation caching, and ticket profile data handling. Fixes address
  issues with record field widgets, cache performance, and message attachment loading.
  A security update restricts the use of the `?loglevel` query parameter to specific
  conditions.
