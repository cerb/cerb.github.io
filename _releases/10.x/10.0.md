...
jumbotron:
  title: "10.0"
excerpt: Cerb 10.0 is a platform upgrade released in April 2021 with 216 improvements
  from community feedback.
summary: This page details the release of Cerb 10.0, a significant platform upgrade
  launched on April 27, 2021, featuring over 216 new enhancements and features driven
  by community feedback. Key updates include the introduction of automations, interactions,
  toolbars, resources, maps, and sheets, which enhance workflow customization and
  data visualization. The release also introduces project boards with automation-driven
  card content and column toolbars, new data query types, and improvements in records
  management, including attachments, connected accounts, and custom fields. The platform
  now supports PHP 8 and includes a streamlined installer process. Deprecated features
  and plugins have been retired, with many functionalities reimplemented using modern
  interaction toolbars and automations. The update emphasizes improved performance,
  security, and user experience, with a focus on making workflows more efficient and
  customizable. Users are advised to back up their systems before upgrading and to
  check their eligibility for a free update based on their license expiration date.
