...
jumbotron:
  title: 10.2.5
excerpt: Cerb 10.2.5 is a maintenance update released in July 2022 with 22 improvements
  from community feedback.
summary: This page details the release notes for Cerb version 10.2.5, a maintenance
  update launched on July 13, 2022. It highlights 22 minor features and fixes based
  on community feedback from the 10.2 update. Key additions include enhancements to
  dashboards, such as improved chooser prompts and new data query formats like pie
  charts. Changes also focus on performance improvements, such as optimizing record
  editor menus and sorting functionalities in worklists. Several fixes address issues
  with OAuth2 token generation, ticket automation, attachment downloads, and data
  query metrics. Security updates include dependency upgrades for Smarty and Guzzlehttp
