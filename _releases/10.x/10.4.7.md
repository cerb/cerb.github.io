...
jumbotron:
  title: 10.4.7
excerpt: Cerb 10.4.7 is a maintenance update released in January 2024 with 12 improvements
  from community feedback.
summary: This page details the release notes for Cerb version 10.4.7, a maintenance
  update launched on January 12, 2024. It highlights 12 minor features and fixes based
  on community feedback from the 10.4 update. Key additions include a global keyboard
  shortcut for the search menu, enhancements in worker interaction automations, and
  filterable automation logs for developers. Changes involve UI improvements like
  consistent styling for date picker inputs and performance enhancements for the `@mention`
  menu. Fixes address issues in the API, search UX, record maintenance, and worklist
  display on narrow screens. The update reflects ongoing efforts to refine user experience
