...
excerpt: Quickly attach files to messages by dragging and dropping them from your
  computer.
summary: This page provides a tip for Cerb users on how to efficiently add attachments
  to messages. It explains that users can drag and drop files directly from their
  computer into the Attachments section while composing or replying to a message.
  A green dashed outline will appear to indicate the correct drop area. This method
  is highlighted as being quicker than using the traditional file chooser popup. Once
  the file is uploaded, it will appear as a typical attachment.
layout: integration
